...
4. No terminal do VS Code, abra o Python apenas inserindo o comando: `python`

5. Experimente o interpretador do Python inserindo `print("Hello World")`. O Python retornará a declaração "Olá, Mundo".
