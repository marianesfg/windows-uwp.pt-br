...
<td><a href="/dotnet/framework/winforms/getting-started-with-windows-forms">Introdução</a><br/><a href="https://docs.microsoft.com/dotnet/api/index">Referência de API (.NET)</a></td>
</tr>
</tbody>
</table>
