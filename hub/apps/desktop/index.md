            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Aprimore seus aplicativos existentes do WPF, Windows Forms e Win32 com os recursos do Windows mais recentes.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>UWP (Plataforma Universal do Windows)</h3>
                        <p></p>A plataforma de ponta para jogos e aplicativos do Windows 10.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Win32</h3>
                        <p></p>A plataforma original para aplicativos nativos do Windows em C/C++ que exigem acesso direto ao Windows e ao hardware. </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>WPF</h3>
                    <p>A plataforma estabelecida para aplicativos do Windows gerenciados com um modelo XAML de interface do usuário e acesso ao .NET Framework completo.</p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>Windows Forms</h3>
                    <p>Desenvolva rapidamente aplicativos de linha de negócios com um modelo de interface do usuário leve e acesso ao .NET Framework completo. </p>
                  </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                    <h3>.NET</h3>
                    <p>A plataforma de desenvolvimento eficaz e abrangente que fornece a infraestrutura sobre a qual aplicativos WPF e Windows Forms são executados.</p>
                  </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://docs.microsoft.com/microsoft-edge/progressive-web-apps">Aplicativos Web Progressivos</a></p>
                        <p><a href="https://docs.microsoft.com/previous-versions/windows/">Arquivos de docs para Windows 8.x e versões anteriores</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://docs.microsoft.com/windows/project-rome/">Projeto Roma</a></p>
                        <p><a href="https://adaptivecards.io/">Cartões Adaptáveis</a></p>
                        <p><a href="https://developer.microsoft.com/graph">Microsoft Graph</a></p>
                        <p><a href="https://docs.microsoft.com/virtualization/#pivot=main&panel=containers">Contêineres do Windows</a></p>
                        </div>
                    </div>
                </div>
            </div>
