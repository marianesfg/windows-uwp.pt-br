---
Description: Esta seção ajuda você a entender como certos recursos importantes do Windows têm suporte em diferentes plataformas de aplicativos e como começar a usar os recursos em seu código.
...
ms.locfileid: "71339347"
---
# <a name="features-and-technologies-for-windows-apps"></a>Recursos e tecnologias para aplicativos do Windows

Independentemente do tipo de aplicativo que você está criando ou do dispositivo que você está direcionando, o Windows dá suporte a muitos recursos que são principais blocos de construção para cenários de aplicativos importantes. Alguns desses recursos são expostos à Plataforma Universal do Windows (UWP), Win32 (API do Windows) e outras plataformas de aplicativos de maneiras diferentes. Os artigos a seguir ajudam você a entender como determinados recursos do Windows têm suporte em diferentes plataformas de aplicativos e como começar a usar os recursos em seu código.

Este artigo fornece uma lista personalizada de artigos para ler mais sobre como você pode acessar recursos e tecnologias importantes do Windows nas plataformas de aplicativos UWP, Win32 (API do Windows), WPF e Windows Forms. Para obter informações completas sobre os recursos de desenvolvimento de cada plataforma, consulte os seguintes recursos:

* [Documentação do UWP](/windows/uwp/index)
...
## <a name="key-windows-features-and-technologies"></a>Principais recursos e tecnologias do Windows
...
Para obter mais informações sobre as diferentes maneiras de usar o Windows Ink em aplicativos do Windows, consulte [Windows Ink](/windows/uwp/design/input/pen-and-stylus-interactions).
...
O Windows fornece várias maneiras de integrar o reconhecimento de fala e conversão de texto em fala (também conhecido como TTS ou síntese de fala) diretamente na experiência do usuário do seu aplicativo. A fala pode ser uma maneira robusta e agradável para as pessoas interagirem com seu aplicativo, complementando ou até mesmo substituindo, teclado, mouse, toque e gestos.

Para obter mais informações sobre as diferentes maneiras de usar interações de fala em aplicativos do Windows, consulte [interações de fala](/windows/uwp/design/input/speech-interactions).

### <a name="windows-ai"></a>IA do Windows

![IA do Windows](images/windows-ai.png)

Oferecemos várias soluções de ia diferentes que você pode usar para aprimorar seus aplicativos do Windows. Com o Windows Machine Learning, você pode integrar modelos de aprendizado de máquina treinados a seus aplicativos e executá-los localmente no dispositivo. As habilidades do Windows Vision permitem que você use bibliotecas predefinidas para realizar tarefas comuns de processamento de imagens ou crie suas próprias soluções personalizadas. O DirectML fornece APIs em estilo DirectX de baixo nível que permitem que você aproveite ao máximo o hardware.

Para obter mais informações sobre as diferentes maneiras de integrar o AI em aplicativos do Windows, consulte [ia do Windows](https://docs.microsoft.com/windows/ai/).

## <a name="features-and-technologies-by-platform"></a>Recursos e tecnologias por plataforma

As seções a seguir fornecem links úteis para saber mais sobre como integrar com os principais recursos e tecnologias do Windows de nossas principais plataformas de aplicativos: UWP, Win32 (API do Windows), WPF e Windows Forms.
