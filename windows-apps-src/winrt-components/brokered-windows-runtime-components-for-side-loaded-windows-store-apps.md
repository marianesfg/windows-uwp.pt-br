...
#<a name="brokered-windows-runtime-components-for-a-side-loaded-windows-store-app"></a>Componentes agenciados do Tempo de Execução do Windows para um aplicativo de sideload da Windows Store
