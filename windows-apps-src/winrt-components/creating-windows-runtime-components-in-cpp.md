...
Uma enumeração de tempo de execução do Windows em C++ c++ /CX é declarada usando enumeração de classe pública; ele é semelhante a uma enumeração em escopo em C++ padrão.
