---
author: Jwmsft
Description: "Saiba como navegar em um aplicativo básico de duas páginas da Plataforma Universal do Windows (UWP)."
title: "Navegar entre duas páginas"
...
# Navegar entre duas páginas

Saiba como navegar em um aplicativo básico de duas páginas da Plataforma Universal do Windows (UWP).

![exemplo de navegação de duas páginas](images/nav-peertopeer-2page.png)
...
## Transmitir informações entre páginas
...
Em Page2.xaml, substitua o [**HyperlinkButton**](https://msdn.microsoft.com/library/windows/apps/br242739) que você adicionou antes com o seguinte [**StackPanel**](https://msdn.microsoft.com/library/windows/apps/br209635).

Aqui, adicionamos um [**TextBlock**](https://msdn.microsoft.com/library/windows/apps/br209652) que exibirá o texto fornecido pela entrada do [**TextBox**](https://msdn.microsoft.com/library/windows/apps/br209683) em Page1.
