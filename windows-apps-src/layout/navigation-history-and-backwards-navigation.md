...
isNew: true
label: Histórico e navegação regressiva
template: detail.hbs
---
...
Quando o usuário alternar para outro aplicativo e retorna ao seu aplicativo, nós recomendamos retornar para a última página no histórico de navegação.
