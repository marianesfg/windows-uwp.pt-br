...
Você pode escolher entre três maneiras de se conectar ao Portal de Dispositivos: USB, host local e pela rede local (incluindo VPN e compartilhamento de Internet).

**Para se conectar ao Portal de Dispositivos**
