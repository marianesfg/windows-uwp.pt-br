...
| :---          | :--- |
| necessárias   | (**necessário**) Determina se o HTTPS é necessário ou não para o Device Portal. Os valores possíveis são **yes**, **no** e **default**. |
...
## <a name="holographic-thermal"></a>Térmico holográfico
...
## <a name="hsimulation-control"></a>Controle de HSimulation
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| prioridade   | (**necessário na criação de um fluxo de controle**) Indica a prioridade do fluxo. |
...
### <a name="get-the-simulation-mode"></a>Obter o modo de simulação
...
### <a name="set-the-simulation-mode"></a>Definir o modo de simulação
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| modo   | (**necessário**) Indica o modo de simulação. Os valores possíveis incluem **default**, **simulation**, **remote** e **legacy**. |
...
## <a name="hsimulation-playback"></a>Reprodução de HSimulation
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação a ser excluída. |
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação pela qual você se interessa. |
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação a ser carregada. |
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação a ser pausada. |
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação a ser reproduzida. |
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação a ser parada. |
...
| Parâmetro do URI | Descrição |
| :---          | :--- |
| gravação   | (**necessário**) O nome da gravação a ser descarregada. |
...
## <a name="hsimulation-recording"></a>Gravação de HSimulation
...
## <a name="mixed-reality-streaming"></a>Streaming de realidade mista
