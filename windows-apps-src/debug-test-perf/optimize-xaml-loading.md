...
Analisar marcações XAML para construir objetos na memória é demorado para uma interface do usuário complexa. Eis o que você pode fazer para melhorar a análise e o tempo de carregamento de sua marcação XAML, bem como a eficiência de memória do seu aplicativo.
...
Como os painéis de layout têm uma propriedade [Background](https://msdn.microsoft.com/library/windows/apps/BR227512) não é preciso puxar um [Rectangle](https://msdn.microsoft.com/library/windows/apps/BR243371) na frente de um painel apenas para colori-lo.
...
Normalmente, você usa [dicionários de recursos](../controls-and-patterns/resourcedictionary-and-xaml-resource-references.md) para armazenar, em um nível um pouco global, recursos aos quais você deseja fazer referência em vários lugares no seu aplicativo. Por exemplo, estilos, pincéis, modelos e assim por diante.
...
Use um elemento composto em vez de mostrar vários elementos em camadas para criar um efeito. Nesse exemplo, o resultado é uma forma de dois tons em que a metade superior é preta (do plano de fundo do [Grid](https://msdn.microsoft.com/library/windows/apps/BR242704)) e a metade inferior é cinza (do [Rectangle](https://msdn.microsoft.com/library/windows/apps/BR243371) branco semitransparente em combinação alfa sobre o plano de fundo preto do **Grid**). Aqui, 150% dos pixels necessários para obter o resultado estão sendo preenchidos.
