...
*Atualização dos criadores do segundo semestre* |  | *16225* | SDK do Insider Preview
...
Para obter mais informações, consulte **[Código adaptável de versão](version-adaptive-code.md)**.
