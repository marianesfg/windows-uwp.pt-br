...
## Configurar o Device Portal no HoloLens
...
- **Show floor**: exibe um plano de chão quadriculado.
- **Show frustum**: exibe o tronco de exibição.
- **Show stabilization plane**: exibe o plano que o HoloLens usa para estabilizar o movimento.
...
- **PV camera**: captura o fluxo de vídeo da câmera de foto/vídeo.
...
- **Reprodução**: clique ou toque em Upload recording para selecionar um arquivo .xef do computador e enviar os dados ao HoloLens.
