...
**Teste de reinstalação:** Certifique-se de que a funcionalidade do aplicativo possa ser restaurada por meio da reinstalação do seu aplicativo depois de atualizar o computador para Windows 10 de um sistema operacional de baixo nível. Se seu aplicativo não passar no teste de atualização e você não for capaz de reduzir a causa desses problemas, é possível que uma reinstalação possa restaurar a perda de funcionalidade. Passar em um teste de reinstalação indica que partes do aplicativo podem não ter sido migradas para o Windows 10.
