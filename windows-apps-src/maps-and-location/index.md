...
> [!TIP]
> Para saber mais sobre como usar mapas e local no seu aplicativo, baixe os exemplos a seguir do [repositório Windows-universal-samples](https://go.microsoft.com/fwlink/p/?LinkId=619979) no GitHub:
