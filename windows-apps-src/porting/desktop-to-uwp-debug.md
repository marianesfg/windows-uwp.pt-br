...
3. Assinar seu aplicativo usando esse certificado, consulte [assinar um pacote de aplicativo usando o SignTool](../packaging/sign-app-package-using-signtool.md).
...
Ver [testar seu aplicativo do Windows para Windows 10 S](https://docs.microsoft.com/windows/uwp/porting/desktop-to-uwp-test-windows-s).
