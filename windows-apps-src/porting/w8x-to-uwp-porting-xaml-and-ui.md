...
**Observação**  o estado visual PointerOver é relevante em estilos/modelos personalizados em aplicativos do Windows 10 e em aplicativos do Windows Runtime 8. x, mas não em aplicativos da loja do Windows Phone. Por esse motivo (e por causa das chaves de recurso do sistema que são compatíveis com aplicativos do Windows 10), é recomendável que você reutilize estilos/modelos personalizados de seus aplicativos do Windows Runtime 8. x ao portar seu aplicativo para Windows 10.
