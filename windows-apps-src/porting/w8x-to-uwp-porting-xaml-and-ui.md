...
| **GridView**, **ListView** | Para **GridView**/**ListView**, consulte [Mudanças na GridView/ListView](#gridview). |
...
| **ListPickerFlyout**, **PickerFlyout**  | **ListPickerFlyout** e o **PickerFlyout** foram substituídos para um aplicativo do Windows 10. Para um menu suspenso de seleção única, use [**MenuFlyout**](https://msdn.microsoft.com/library/windows/apps/dn299030); para obter experiências mais complexas, use [**Flyout**](https://msdn.microsoft.com/library/windows/apps/dn279496). |
