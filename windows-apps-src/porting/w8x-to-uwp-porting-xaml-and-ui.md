...
Um aplicativo Universal 8.1 em execução no Windows 10 manterá a aparência 8.1 e o comportamento em relação aos controles. Porém, quando você porta esse aplicativo para um aplicativo do Windows 10, existem algumas diferenças na aparência e o comportamento a serem consideradas. A arquitetura e o design de controles é essencialmente inalterados para aplicativos do Windows 10, portanto, as alterações são principalmente em torno de [linguagem de design](#design-language-in-windows-10), na simplificação e melhorias de usabilidade.
...
Em um aplicativo do Windows Phone Store, o viewexpands reduzida para thesize da tela. Em um aplicativo do Windows Runtime 8. x e em um aplicativo do Windows 10, o tamanho da exibição reduzida é restrito aos limites do controle **SemanticZoom** .
