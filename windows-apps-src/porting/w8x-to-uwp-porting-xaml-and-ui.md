...
|--------------|--------|
| **AppBar**   | Se você estiver usando o controle **AppBar** ([**CommandBar**](https://msdn.microsoft.com/library/windows/apps/hh701927) é recomendado em vez disso), em seguida, ele não fica oculto por padrão em um aplicativo do Windows 10. É possível controlar isso usando a propriedade [**AppBar.ClosedDisplayMode**](https://msdn.microsoft.com/library/windows/apps/dn633872). |
...
-   A propriedade [**IsSwipeEnabled**](https://msdn.microsoft.com/library/windows/apps/hh702518) (somente Windows Runtime 8. x aplicativos) não há suporte para aplicativos do Windows 10. A API ainda está presente, mas sua definição não tem efeito. Todos os gestos de seleção anteriores têm suporte, exceto o de passar o dedo para baixo (que não tem suporte porque os dados mostram que ele não é detectável) e o clique com o botão direito do mouse (que é reservado para mostrar um menu de contexto).
-   A propriedade [**ReorderMode**](https://msdn.microsoft.com/library/windows/apps/dn625099) (somente aplicativos da loja do Windows Phone) não há suporte para aplicativos do Windows 10. A API ainda está presente, mas sua definição não tem efeito. Em vez disso, defina [**AllowDrop**](https://msdn.microsoft.com/library/windows/apps/br208912) e [**CanReorderItems**](https://msdn.microsoft.com/library/windows/apps/br242882) como true em **GridView** ou **ListView**, e o usuário poderá reordenar usando um gesto de pressionar e manter pressionado (ou clicar e arrastar).
...
Em um aplicativo do Windows Runtime 8. x, quando o aplicativo é desativado e reativado, a exibição reduzida é ignorada (se ele estivesse sendo mostrado) e a exibição ampliada é mostrada em vez disso. Em um aplicativo da loja do Windows Phone e em um aplicativo do Windows 10, a exibição reduzida permanecerá se ela estiver sendo mostrada.
