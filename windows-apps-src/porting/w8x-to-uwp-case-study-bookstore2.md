...
-   Copie BookstoreStyles.xaml. Esse será um ótimo ponto de partida porque todas as chaves de recurso desse arquivo serão resolvidas em um aplicativo do Windows 10; algumas delas não serão resolvidas no arquivo equivalente do WindowsPhone.
...
Agora, é possível compilar e executar. Esta é a aparência do nosso novo aplicativo UWP, sem ainda ter tido nenhum trabalho para portá-lo para o Windows 10.
...
O aplicativo do Windows 10 com as mudanças de código-fonte iniciais em execução em um dispositivo de desktop, exibição ampliada
...
O aplicativo do Windows 10 com as mudanças de código-fonte iniciais em execução em um dispositivo de desktop, exibição reduzida
