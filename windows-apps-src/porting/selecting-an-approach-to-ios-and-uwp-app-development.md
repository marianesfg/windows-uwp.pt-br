...
-   Mecanismos de jogo
    ...
    Com ferramentas como [Unity3D](https://go.microsoft.com/fwlink/p/?LinkID=320479) e [Unreal Engine](https://go.microsoft.com/fwlink/p/?LinkID=394062) à disposição, é possível escrever jogos de qualidade AAA para o Windows e em muitas outras plataformas, inclusive iOS. O Unity dá suporte a scripts em C#; o Unreal usa C++.
