...
<td align="left">Diretrizes de <strong>design de material do Android</strong> fornecem uma linguagem visual para designers e desenvolvedores de Android seguirem.</td>
...
<tr class="even">
<td align="left"><strong>Controle a manipulação de eventos.</strong> <br><br>Definir a lógica que é executada quando os eventos são acionados dentro de controles de interface do usuário.</td>
...
<td align="left">Você pode editar as <strong>propriedades</strong> dos controles na marcação XAML ou programaticamente, usando o Visual Studio e o Blend for Visual Studio.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt228345.aspx">Adicionar controles e manipular eventos</a></td>
</tr>
<tr class="even">
...
<td align="left"><strong><a href="https://msdn.microsoft.com/library/windows/apps/dn449149.aspx">Hubs</a></strong>  permitem que você mostra ao usuário uma visualização do conteúdo que pode ser selecionada para navegar até as páginas filho. <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997765.aspx">Mestre/detalhes</a></strong>  permitem que os usuários a escolher de uma lista de resumos do item que é exibida ao lado da seção de detalhes correspondente.<br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigation-basics">Navegação</a><br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigate-between-two-pages">Navegar entre as duas páginas</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Botão de navegação de volta.</strong> <br><br>Navegar de volta através de um aplicativo.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Dados de aplicativo local.</strong> <br><br>Armazenamento de configurações e arquivos relacionados a seu aplicativo localmente.</td>
...
<td align="left">Você pode armazenar dados usando <strong>SQLite</strong>. <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592863.aspx">Entity Framework</a></strong>  é um ORM internos que elimina a necessidade de escrever muito código de acesso de dados e permite que você consulte facilmente o banco de dados sem escrever em SQL. Você pode executar consultas SQL diretamente com a <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592864.aspx">biblioteca SQLite</a>.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592862.aspx">Acesso a dados</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Bibliotecas HTTP para o acesso REST.</strong> <br><br>Bibliotecas internas que permitem que você se comunique com serviços web e servidores web usando HTTP(S).<br/></td>
...
<tr class="even">
<td align="left"><strong>Bibliotecas de OAuth.</strong> <br><br>As bibliotecas OAuth permitem acesso a provedores OAuth de terceiros e qualquer gerenciamento de conta criado na plataforma.</td>
...
<td align="left"><strong><a href="https://www.visualstudio.com/features/universal-windows-platform-vs.aspx">Visual Studio</a></strong>  e <strong><a href="https://msdn.microsoft.com/library/jj171012.aspx">Blend para Visual Studio</a></strong> tem todas as ferramentas que você precisa de código, criar, conectar-se, depurar, analisar, otimizar e testar aplicativos UWP. O Visual Studio também oferece a você <strong><a href="https://msdn.microsoft.com/library/windows/apps/mt188754.aspx">emuladores</a></strong> para dispositivos Windows 10, para que você possa testar seu aplicativo em uma ampla gama de dispositivos emulados.<br/><br/><a href="https://dev.windows.com/downloads">Downloads e ferramentas para UWP</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Organização do código.</strong> <br><br>A estrutura de pastas básica de um aplicativo, geralmente criada a partir de um modelo inicial.</td>
...
<td align="left">Cada atividade tem seu próprio <strong>ciclo de vida de atividade</strong> com estados como <strong>reiniciado</strong>. <strong>Retornos de chamada do ciclo de vida</strong> , como <strong>onResume</strong> são implementadas em seu <strong>classes atividade</strong>.</td>
...
<td align="left">Seu aplicativo tem os <strong>estados de execução do aplicativo</strong> NotRunning, Activated, Running, Suspending, Suspended e Resuming.<br/><br/>Você pode implementar os métodos da <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.application.aspx">classe de Aplicativo</a></strong> OnLaunched, OnActivated, Suspending ou Resuming em seu aplicativo para executar códigos quando o estado é alterado.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt243287.aspx">Ciclo de vida do aplicativo</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td align="left"><strong>Otimização de exibição para uma interface de usuário responsiva.</strong> <br><br>Melhorar o desempenho por meio da otimização dos modos de exibição.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Otimização de modo de exibição de lista.</strong> <br><br>Padrões internos para ajudar com a otimização de listas de dados, que costumam ter desempenho insatisfatório quando grandes quantidades de dados precisam ser mostradas</td>
...
<td align="left">Você cria compras de produto no aplicativo para seu aplicativo <a href="https://msdn.microsoft.com/library/windows/apps/mt148551.aspx">adicionando-os ao seu aplicativo e enviando-os para a Loja</a>. <br/><br/>Você usa a <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.currentapp.aspx">classe CurrentApp</a></strong> para definir as compras no aplicativo. <br/><br/>Você usa <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.currentapp.requestproductpurchaseasync.aspx">CurrentApp.RequestProductPurchaseAsync</a></strong> para exibir a interface do usuário que permite que os clientes comprem o produto.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt219684.aspx">Habilitar compras de produtos no aplicativo</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Compras de consumo no aplicativo.</strong> <br><br>Os produtos no aplicativo que podem ser comprados, usados e depois comprados novamente.</td>
...
<td align="left">Você pode testar compras no aplicativo simplesmente usando a classe <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.currentappsimulator.aspx">CurrentAppSimulator</a></strong> no lugar de CurrentApp.<br/><br/></td>
</tr>
<tr class="even">
...
<td align="left">O Google Play <strong>oficialmente não dá suporte a versões de avaliação do aplicativo</strong>. As avaliações ou a remoção de publicidade são obtidas com a criação de uma compra no aplicativo e colocando o caminho de código adequado no momento da confirmação de compra bem-sucedida.</td>
...
<td align="left">Você pode oferecer uma versão de avaliação gratuita do seu aplicativo usando a <strong><a href="https://msdn.microsoft.com/library/windows/apps/mt148548.aspx">opção de avaliação gratuita</a></strong> ao enviar seu aplicativo para a Loja. Você pode usar <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.licenseinformation.istrial.aspx">LicenseInformation.IsTrial</a></strong> para verificar o status de avaliação do aplicativo e apresentar diferentes caminhos de código adequadamente. Você pode se registrar no <a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.licenseinformation.licensechanged">evento LicenseChanged</a> para ser notificado quando o usuário altera o status de avaliação enquanto o aplicativo está sendo executado.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt219685.aspx">Excluir ou limitar recursos em uma versão de avaliação</a></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td align="left"><strong>Interface do usuário adaptável: adaptados layouts.</strong> <br><br>Oferece suporte a diferentes tamanhos de tela com layouts de destino separados.</td>
...
<tr class="even">
<td align="left"><strong>Exibir notificações.</strong> <br><br>Tipos de notificações que podem ser exibidas.</td>
...
<td align="left">Notificações locais são criadas usando <strong>UILocalNotification</strong>e pode ser programado com <b> UILocalNotification.scheduleLocalNotification:<strong>. | Você pode agendar uma notificação do sistema usando</strong>  <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.scheduledtoastnotification.aspx">ScheduledToastNotification</a><strong>. Você pode enviar uma notificação de bloco do seu aplicativo usando a</strong> <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.tilenotification.aspx">classe TileNotification</a><strong>, ou agendar uma notificação de bloco com <a href="https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.notifications.scheduledtilenotification.aspx">ScheduledTileNotification</a>.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt631604.aspx">Notificações do sistema interativas e adaptáveis</a><br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt593299.aspx">Enviar uma notificação de bloco local</a> | | </strong>Enviar notificações por push.</b> Uma notificação enviada de um servidor de notificação por push e, opcionalmente, manipulada no aplicativo.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Mídia de captura.</strong> <br><br>Gravação de conteúdo de áudio e vídeo.</td>
...
<td align="left">O <strong>Core local</strong> <strong>CLLocationManager</strong> classe é usada para monitorar o local de um dispositivo, com <strong>startUpdatingLocation</strong> para o serviço de localização padrão e o <strong>startMonitoringSignificantLocationChanges</strong> para o <strong>alteração significativa</strong> serviço local.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Invocação de outro aplicativo.</strong> <br><br>Iniciar outro aplicativo e, opcionalmente, compartilhar dados como links, texto, fotos, vídeos e arquivos.</td>
...
<tr class="even">
<td align="left"><strong>Arraste e solte.</strong> <br><br>Arrastar e soltar conteúdo entre aplicativos.</td>
