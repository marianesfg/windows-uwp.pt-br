...
| _Erro de XamlCompiler WMC0055: Não é possível atribuir o valor de texto '&lt;geometria seu fluxo&gt;' na propriedade Clip do tipo 'RectangleGeometry'_ | Na UWP, o tipo do aplicativo [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) e XAML C++ UWP. |
...
| _Erro de XamlCompiler WMC0011: Membro desconhecido 'OpacityMask' no elemento '&lt;tipo de UIElement&gt;'_ | O aplicativo UWP [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) e XAML C++ UWP. |
| _Ocorreu uma exceção de primeira chance do tipo 'COMException' no sistema. NI. DLL. Informações adicionais: O aplicativo chamado uma interface que foi tratada por um thread diferente. (Exceção de HRESULT: 0X8001010E (RPC_E_WRONG_THREAD))._ | O trabalho que você está fazendo precisa ser feito no thread da interface do usuário. Chame o [**CoreWindow.GetForCurrentThread**](https://msdn.microsoft.com/library/windows/apps/hh701589)). |
