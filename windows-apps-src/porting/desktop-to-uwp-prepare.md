...
+ __Seu aplicativo usa o diretório de trabalho atual__. No tempo de execução, seu aplicativo da área de trabalho empacotado não terá o mesmo diretório trabalho especificado anteriormente em sua área de trabalho. Atalho LNK. Você precisará alterar seu CWD no tempo de execução se ter o diretório correto é importante para seu aplicativo funcionar corretamente.
...
+ __Seu aplicativo gera código__. Seu aplicativo pode gerar o código que ele consome na memória, mas evite gravar código gerado em disco, pois o processo de certificação de aplicativos Windows não consegue validar o código antes do envio de aplicativo. Além disso, os aplicativos que gravam código em disco não serão executados adequadamente em sistemas que executam o Windows 10 S. Isso pode bloquear o seu aplicativo do envio à Microsoft Store porque todos os aplicativos enviados para a Microsoft Store devem ser compatíveis com o Windows 10 S.

>[!IMPORTANT]
> Depois que tiver criado seu pacote de aplicativo do Windows, por favor, teste seu aplicativo para garantir que ele funciona corretamente em sistemas que executam o Windows 10 S. Todos os aplicativos enviados para a Microsoft Store devem ser compatíveis com Windows 10 S. os aplicativos que não são compatíveis não são aceitos na loja. Consulte [Testar seu aplicativo do Windows para o Windows 10 S](desktop-to-uwp-test-windows-s.md).
