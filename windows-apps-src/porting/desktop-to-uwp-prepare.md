...
>[!IMPORTANT]
> Depois que tiver criado seu pacote de aplicativo do Windows, por favor, teste seu aplicativo para garantir que ele funciona corretamente em sistemas que executam o Windows 10 S. Todos os aplicativos enviados à Microsoft Store devem ser compatíveis com Windows 10 S. os aplicativos que não são compatíveis não são aceitos na loja. Consulte [Testar seu aplicativo do Windows para o Windows 10 S](desktop-to-uwp-test-windows-s.md).
