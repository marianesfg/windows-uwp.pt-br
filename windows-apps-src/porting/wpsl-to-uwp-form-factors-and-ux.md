...
#  Portabilidade do Windows Phone Silverlight para UWP para fator forma e experiência do usuário
...
## Fatores forma diferentes e a experiência do usuário
...
## Qual é realmente o tamanho de uma tela?
...
## Resolução de toque e resolução de exibição
...
Além do layout dinâmico integrado aos controles do sistema e painéis de layout, podemos usar um novo recurso do Windows 10 chamado [Gerenciador de Estado Visual Adaptável](wpsl-to-uwp-porting-xaml-and-ui.md#adaptive-ui).
...
Consulte novamente a lista [maximizando a reutilização de marcação e de código](wpsl-to-uwp-porting-to-a-uwp-project.md#markup-and-code-reuse) para obter técnicas de compartilhamento da sua interface do usuário com dispositivos de destino com uma ampla variedade de fatores forma.

## Mais informações e diretrizes de design
