...
-   Você poderá remover muitas diretivas de compilação condicional no código-fonte do seu aplicativo Universal 8.1 caso precise somente de suporte para o Windows 10. Consulte [Compilação condicional e código adaptável](#conditional-compilation-and-adaptive-code) neste tópico.
...
* [O tempo de execução do Windows do JumpStart app 8. x usando modelos (c#, C++, Visual Basic)](https://msdn.microsoft.com/library/windows/apps/hh768232)
