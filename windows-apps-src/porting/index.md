...
| Tópico | Descrição |
|-------|-------------|
| [Mudar do desktop para a UWP](desktop-to-uwp-migrate.md) | Escolha uma das várias opções para trazer as experiências da UWP para seus aplicativos da área de trabalho Win32 e .NET. |
