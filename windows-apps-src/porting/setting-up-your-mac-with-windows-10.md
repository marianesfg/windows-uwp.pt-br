...
Depois que você tiver o Windows em execução, será possível instalar o Visual Studio 2015 a partir do [Downloads de desenvolvedor para Windows 10](http://go.microsoft.com/fwlink/p/?LinkId=302144) e começar a criar aplicativos!
