...
## Detectando a plataforma em que seu aplicativo é executado.
...
Além disso, consulte também [Compilação condicional e código adaptável](wpsl-to-uwp-porting-to-a-uwp-project.md#conditional-compilation).
