...
title: Portando XAML e a interface do usuário do Windows Phone Silverlight para a UWP
ms.assetid: 49aade74-5dc6-46a5-89ef-316dbeabbebe
---

#  Portando XAML e a interface do usuário do Windows Phone Silverlight para a UWP
...
## Pixels de exibição/efetivos, distância de exibição e fatores de escala
