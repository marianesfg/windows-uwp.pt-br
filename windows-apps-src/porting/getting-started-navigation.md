...
**Observação**  Para informações sobre a navegação para aplicativos UWP como usar JavaScript e HTML, consulte [início rápido: usando a navegação de página única](https://msdn.microsoft.com/library/windows/apps/hh452768).
