...
title: Ponte de Desktop para Plataforma Universal do Windows
ms.author: normesta
ms.date: 03/09/2017
ms.topic: article
ms.prod: windows
...
translationtype: HT
---
# <a name="desktop-to-universal-windows-platform-uwp-bridge"></a>Ponte de Desktop para Plataforma Universal do Windows

Conheça a Ponte de Desktop para UWP e converta o aplicativo da área de trabalho do Windows em um aplicativo da Plataforma Universal do Windows (UWP).
