...
| IU XAML | Windows 10, lançamentos de versões 1809 e anteriores não dão suporte hospedagem conteúdo de UWP XAML em aplicativos da área de trabalho empacotados. A partir do Windows 10, versão 1903, você pode usar [XAML Ilhas](../xaml-platform/xaml-host-controls.md) para hospedar conteúdo XAML UWP.  |
...
Veja a seguir uma lista completa de APIs UWP com suporte em apps empacotados. Você pode exibir [APIs com suporte apenas em aplicativos empacotados](#new) ou [APIs com suporte em aplicativos empacotados e aplicativos da área de trabalho](#both).
