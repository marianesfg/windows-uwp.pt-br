...
ms.locfileid: "75684949"
---
# <a name="getting-started-with-uwp-for-ios-developers"></a>Introdução à UWP para desenvolvedores de iOS


Se você for um desenvolvedor de iOS pensando em desenvolver para o Windows 10, esses documentos serão um ótimo lugar para começar. Eles apresentarão alguns dos conceitos que você precisará saber ao começar a escrever aplicativos, e eles abordarão como você pode publicar seu trabalho na Microsoft Store.
...
O Windows 10 apresenta uma nova plataforma para criar aplicativos atraentes em desktops, laptops, tablets, dispositivos de telefone e muito mais. Como os aplicativos da Plataforma Universal do Windows (UWP) oferecem inúmeros recursos exclusivos, uma simples portagem do seu aplicativo do iOS impossibilitará o uso desses recursos. Portanto, recomendamos que você experimente os novos controles e recursos para ver como eles facilitarão o processo de desenvolvimento e possibilitarão novos aplicativos.

O resultado é este: não apenas portar seu aplicativo, mas **reinventar** seu aplicativo e tirar proveito dos novos recursos e dos novos dispositivos. Não liquide o menor denominador comum, mas crie experiências ricas que usam recursos exclusivos do Windows 10, como blocos dinâmicos, notificações e interação com a Cortana.

Para começar a usar essas orientações, você precisará de um computador com o Windows 10 e o Microsoft Visual Studio instalados. Você pode baixá-los de [downloads para desenvolvedores para programação de aplicativos UWP](https://developer.microsoft.com/windows/downloads). Não tem um PC? Não se preocupe, você pode usar seu Mac: consulte [Instalando o Windows e as ferramentas de desenvolvimento no seu Mac](setting-up-your-mac-with-windows-10.md).
...
| [Introdução: introdução ao Visual Studio](getting-started-getting-around-in-visual-studio.md) | Agora vamos voltar ao projeto que criamos antes e ver como você pode se familiarizar com o IDE (ambiente de desenvolvimento integrado) do Visual Studio. |
...
| [Introdução: navegação](getting-started-navigation.md) | Uma das maneiras de gerenciar essa navegação em um aplicativo do Windows 10 é usar a classe [Frame](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Frame). O guia passo a passo a seguir mostra como você pode tentar fazer isso. |
...
| [Mapeamento de conceito de aplicativo do Windows](https://docs.microsoft.com/windows/uwp/porting/android-ios-uwp-map) | Como pensar em conceitos de iOS em termos de Windows (e Android) |
