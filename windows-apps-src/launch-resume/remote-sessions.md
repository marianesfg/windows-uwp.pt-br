...
description: "Criar experiências compartilhadas em vários dispositivos ingressando-os em uma sessão remota."
...
Para seu app iniciar um app em um dispositivo remoto, você deve adicionar a funcionalidade `remoteSystem` ao manifesto do conjunto de aplicativo. Você pode usar o designer de manifesto de pacote para adicioná-lo selecionando **Sistema Remoto** na guia **Recursos**, ou adicionar manualmente a linha a seguir ao arquivo Package.appxmanifest do projeto.
