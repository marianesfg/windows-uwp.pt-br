...
| [Criar e armazenar uma extensão de app](how-to-create-an-extension.md) | Extensões do aplicativo Gravar e hospedar Plataforma Universal do Windows (UWP) para estender seu aplicativo por meio de pacotes que os usuários podem instalar a partir da Microsoft Store. |
