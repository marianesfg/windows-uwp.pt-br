...
description: Defina a imagem da tela inicial e a cor da tela de fundo do seu aplicativo usando o Microsoft Visual Studio 2015.
...
2.  Em **Solution Explorer**, abra o arquivo "Package.appxmanifest". Você também pode abrir esse arquivo na barra de menus escolhendo **Projeto** > **Loja** > **Editar Manifesto do aplicativo**.
