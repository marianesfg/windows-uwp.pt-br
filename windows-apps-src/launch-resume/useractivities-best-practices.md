...
* **Não crie as atividades de Ações concluídas por outros usuários.** Se uma conta externa envia ao usuário uma mensagem ou @-mentions -los em seu aplicativo, você não deve criar uma atividade para isso. Esse tipo de ação é melhor servido por notificações da Central de ações.
