...
No XML acima, certifique-se de que o `EntryPoint` atributo é definido como o nome de namespace.class de sua classe de tarefa de atualização. O nome diferencia maiusculas de minúsculas.
...
![ponto de interrupção de conjunto](images/run-func-breakpoint.png)
