...
-   Registre a tarefa em segundo plano chamando sua função de registro da tarefa em segundo plano. Para obter mais informações sobre como registrar tarefas em segundo plano, consulte [Registrar uma tarefa em segundo plano](register-a-background-task.md).
    ...
    O código a seguir registra a tarefa em segundo plano para um processo em segundo plano executado em um processo à parte. Se você tivesse chamando uma tarefa em segundo plano executada no mesmo processo como o app de host, você não definiria `entrypoint`:
