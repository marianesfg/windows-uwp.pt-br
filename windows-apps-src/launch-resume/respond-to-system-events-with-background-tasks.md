...
> [!NOTE]
> Aplicativos de plataforma Windows universais devem chamar [**RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485) antes registrando qualquer um dos tipos de gatilho plano de fundo.
