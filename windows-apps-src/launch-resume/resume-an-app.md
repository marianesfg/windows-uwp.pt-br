...
> [!NOTE]
> Porque o evento [**Resuming**](https://msdn.microsoft.com/library/windows/apps/br242339) não é gerado do thread da interface do usuário, um dispatcher deverá ser usado em seu manipulador para despachar todas as chamadas para a interface do usuário.
