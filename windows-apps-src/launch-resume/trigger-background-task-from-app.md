...
Crie um novo [ApplicationTrigger](https://docs.microsoft.com/uwp/api/Windows.ApplicationModel.Background.ApplicationTrigger). Você pode armazená-lo em um campo como é feito no trecho a seguir. Isso é para sua conveniência, para que não é necessário criar uma nova instância mais tarde quando queremos sinalizar o gatilho. Mas você pode usar qualquer instância **ApplicationTrigger** para sinalizar o gatilho.
