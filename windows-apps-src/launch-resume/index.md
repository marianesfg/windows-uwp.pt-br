---
title: Iniciando, retomada e as tarefas em segundo plano
description: Esta seção descreve o que acontece quando um aplicativo da UWP (Plataforma Universal do Windows) é iniciado, suspenso, retomado e encerrado.
ms.assetid: 75011D52-1511-4ECF-9DF6-52CBBDB15BD7
---

# Iniciando, retomada e as tarefas em segundo plano
...
| Tópico                                                                                                            | Descrição                                                                                                                                                                                   |
|------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Oferecer suporte a tarefas em segundo plano em seu aplicativo](support-your-app-with-background-tasks.md)                             | Os tópicos nesta seção mostram como executar seu próprio código leve em segundo plano ao responder a gatilhos com tarefas em segundo plano.                                                       |
