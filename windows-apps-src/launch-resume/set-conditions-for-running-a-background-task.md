...
Também é possível combinar diversas condições ao chamar **AddCondition** diversas vezes no mesmo [**TaskBuilder**](https://msdn.microsoft.com/library/windows/apps/br224768). Tome cuidado para não adicionar condições conflitantes, como **UserPresent**e **UserNotPresent**.
...
Agora, você pode registrar sua tarefa em segundo plano no método [**Register**](https://msdn.microsoft.com/library/windows/apps/br224772), e a tarefa em segundo plano não será iniciada até a condição especificada ser atendida.
...
> [!NOTE]
> Escolha as condições para a tarefa em segundo plano para que seja executada apenas quando necessário e não é executado quando ele não deve. Confira [**SystemConditionType**](https://msdn.microsoft.com/library/windows/apps/br224835) para ver descrições das diferentes condições de tarefas em tela de fundo.
