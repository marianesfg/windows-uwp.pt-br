...
> **Importante**a partir do Windows 10, aplicativos são precisam mais estar na tela de bloqueio como pré-requisito para executar tarefas em segundo plano.
