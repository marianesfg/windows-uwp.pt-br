...
>   **importantes** a partir do Windows 10, não é mais necessário que os aplicativos estejam na tela de bloqueio como um pré-requisito para executar tarefas em segundo plano.
