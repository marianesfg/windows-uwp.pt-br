...
**Tarefas de segundo plano em processo versus fora do processo:** O Windows 10, versão 1607, introduziu [tarefas em segundo plano em processo](create-and-register-an-inproc-background-task.md) que permitem executar código em segundo plano no mesmo processo que o aplicativo em primeiro plano. Leve em consideração os seguintes fatores ao decidir se deseja ter tarefas em segundo plano dentro X fora do processo:
...
**Atualize o manifesto do aplicativo:**  Para tarefas em segundo plano que executam fora do processo, declare cada tarefa em segundo plano no manifesto do aplicativo, junto com o tipo de gatilhos com o qual ele é usado. Do contrário, seu aplicativo não vai poder registrar a tarefa em segundo plano no tempo de execução.
...
*Aplica-se a tarefas em segundo plano em processo e fora do processo*
...
*Aplica-se somente a tarefas em segundo plano em processo*
...
* [Como disparar eventos de suspensão, retomada e segundo plano em aplicativos UWP (ao depurar)](https://go.microsoft.com/fwlink/p/?linkid=254345)
