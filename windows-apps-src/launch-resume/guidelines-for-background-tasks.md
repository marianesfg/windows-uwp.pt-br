...
> **Importante**a partir do Windows 10, os aplicativos são não precisam mais estar na tela de bloqueio como um pré-requisito para executar tarefas em segundo plano.
