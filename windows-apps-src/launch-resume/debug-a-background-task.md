...
* [Analisando a qualidade do código de aplicativos da Windows Store com a análise de código do Visual Studio](https://msdn.microsoft.com/library/windows/apps/xaml/hh441471.aspx)
