...
<div class="alert">
<b>Note</b>  A title can be used for a location if the location is specified by the <b>pos</b> parameter value. Em vez de mostrar a latitude e a longitude, o título será exibido.
</div>
<div>
 
</div></td>
