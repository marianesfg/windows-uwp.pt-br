...
| O número máximo de tarefas em segundo plano do [DeviceUseTrigger](https://msdn.microsoft.com/library/windows/apps/dn297337) ainda não foi alcançado no dispositivo (em que o seu aplicativo está sendo executado). | família de dispositivos da área de trabalho: um número ilimitado de tarefas pode ser registrado e executado paralelamente. |
|  |  |
...
| Limite de tempo no relógio de parede – a quantidade total de tempo em que a tarefa do aplicativo pode ser executada em segundo plano. | família de dispositivos da área de trabalho: 10 minutos. |
|  |  |
