...
-   **Configurações**
    ...
    Veja a seguir tipos de dados que você pode usar para as configurações do aplicativo:
...
## Armazenando dados de aplicativo nos repositórios de dados do aplicativo
...
### Recuperar o repositório de dados de aplicativo local
...
### Criar e recuperar uma configuração de local simples
...
### Criar e recuperar um valor de composição local
...
### Registre-se para receber uma notificação quando os dados de roaming mudarem
...
### Criar e recuperar configurações em roaming
...
### Criar e recuperar arquivos em roaming
...
## Organizar os dados de aplicativo com contêineres
...
## Excluir configurações de aplicativo e contêineres
...
## Controlar a versão de seus dados de aplicativo
...
* [Diretrizes para configurações de aplicativos](guidelines-for-app-settings.md)
