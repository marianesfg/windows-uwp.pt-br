...
-   As etapas da configuração única são:
...
-   A ação a ser executada em suspensão é:
...
```
   ...
   -  Em seguida, extraia o SocketActivityTriggerDetails dos argumentos do evento e descubra o motivo pelo qual o evento foi gerado:
...
A amostra a seguir adiciona uma notificação de gatilho de rede e um gatilho de keep alive abaixo do elemento &lt;Application&gt; no manifesto do aplicativo.
...
**Observação**  No momento, não há suporte a [HttpClient](http://go.microsoft.com/fwlink/p/?linkid=241637) com SSL usando o recurso de gatilho de rede e [**ControlChannelTrigger**](https://msdn.microsoft.com/library/windows/apps/hh701032).
