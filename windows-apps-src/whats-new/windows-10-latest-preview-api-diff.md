---
author: QuinnRadich
title: "Alterações API do Windows 10 Build 16257"
description: "Os desenvolvedores podem usar a seguinte lista para identificar espaços de nomes novos ou alterados na compilação prévia do SDK do Windows 10 atual."
keywords: "novidades, novidade, atualização, lançado, voos, API, 16257"
ms.author: quradic
ms.date: 8/17/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16257"></a>Novas APIs na compilação 16257 prévia do SDK do Windows 10

Espaços de nomes de API novos e atualizados foram disponibilizados para [participantes do Insider Program](https://insider.windows.com/) na compilação prévia 16257 do SDK do Windows 10.

Abaixo se encontra a lista completa da documentação de pré-lançamento publicada para os espaços de nomes, adicionada desde o último lançamento público do Windows 10, [Compilação 1703](windows-10-version-1703-api-diff.md). **Observe que a documentação de pré-lançamento pode estar incompleta e sujeita a alteração, e essas APIs talvez sejam renomeadas ou removidas em compilações subsequentes.** Também há uma lista anexada de nomes de espaços de API alterados ou renomeados desde as compilações prévias do SDK.
...
## <a name="apis-changed-or-removed-since-build-16232"></a>APIs alteradas ou removidas desde a compilação 16232

As seguintes APIs foram disponibilizadas na ou antes da compilação 16232, mas não estão mais presentes nesta compilação. Elas foram renomeadas ou removidas totalmente, e a documentação não é mais fornecida para elas.
...
## <a name="apis-changed-or-removed-since-build-16225"></a>APIs alteradas ou removidas desde a compilação 16225

As seguintes APIs foram disponibilizadas na ou antes da compilação 16225, mas não estão mais presentes nesta compilação. Elas foram renomeadas ou removidas totalmente, e a documentação não é mais fornecida para elas.
