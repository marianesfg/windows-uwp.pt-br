---
author: QuinnRadich
title: "Alterações API do Windows 10 Build 16225"
description: "Os desenvolvedores podem usar a seguinte lista para identificar espaços de nomes novos ou alterados no Windows 10 SDK Preview Build 16190."
keywords: "novidades, novidade, atualização, lançado, voos, API, 16225"
ms.author: quradic
ms.date: 7/6/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16225"></a>Novas APIs no Windows 10 SDK Preview Build 16225

Espaços de nomes de API novos e atualizados foram disponibilizados para [Participantes do Programa Windows Insider](https://insider.windows.com/) no Windows 10 SDK Preview Build 16225.

Abaixo se encontra a lista completa da documentação de pré-lançamento publicada para os espaços de nomes, adicionada ou modificada desde o último lançamento público do Windows 10, [Versão 1703](windows-10-version-1703-api-diff.md). **Observe que a documentação de pré-lançamento pode estar incompleta e sujeita a alteração, e essas APIs talvez sejam renomeadas ou removidas em compilações subsequentes.**
