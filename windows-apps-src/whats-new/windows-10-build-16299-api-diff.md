...
Para saber mais sobre as APIs adicionadas na versão pública anterior, confira [Novas APIs na Atualização do Windows 10 para Criadores](windows-10-build-15063-api-diff.md).
