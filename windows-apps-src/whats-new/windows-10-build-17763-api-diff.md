...
#### <a name="launcher"></a>[Inicializador](https://docs.microsoft.com/uwp/api/windows.system.launcher)
...
#### <a name="menubar"></a>[MenuBar](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)
