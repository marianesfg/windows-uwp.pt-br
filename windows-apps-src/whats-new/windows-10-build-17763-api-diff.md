...
### [<a name="windowsgraphicscapture"></a>Graphics](https://docs.microsoft.com/uwp/api/windows.graphics.capture)
...
### [<a name="windowsuixamlautomationpeers"></a>Peers](https://docs.microsoft.com/uwp/api/windows.ui.xaml.automation.peers)
...
### [<a name="windowsuixamlcontrols"></a>Controls](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls)
...
#### [<a name="border"></a>Borda](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### [<a name="control"></a>Controle](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### [<a name="frame"></a>Quadro](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)

Frame.IsNavigationStackEnabled <br> Frame.IsNavigationStackEnabledProperty <br> Frame.NavigateToType

#### [<a name="grid"></a>Grade](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid)
...
#### [<a name="menubar"></a>Barra de menus](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

Barra de menus <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> Barra de menus. #ctor
...
#### [<a name="panel"></a>Painel](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
SplitButton <br> SplitButton.Click <br> SplitButton.Command <br> SplitButton.CommandParameter <br> SplitButton.CommandParameterProperty <br> SplitButton.CommandProperty <br> SplitButton.Flyout <br> SplitButton.FlyoutProperty <br> #Ctor SplitButton.
...
### [<a name="windowsuixamlhosting"></a>Hosting](https://docs.microsoft.com/uwp/api/windows.ui.xaml.hosting)
...
### [<a name="windowsuixamlmarkup"></a>. XAML. Markup](https://docs.microsoft.com/uwp/api/windows.ui.xaml.markup)
...
#### [<a name="brush"></a>Pincel](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
