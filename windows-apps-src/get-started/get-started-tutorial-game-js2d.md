---
title: "Tutorial de Introdução - um jogo UWP em JavaScript"
description: Um jogo simples UWP para a Windows Store, escrito em JavaScript e CreateJS
author: jken
ms.author: jken
ms.date: 02/09/2017
ms.topic: article
...
---
# <a name="get-started-tutorial-a-uwp-game-in-javascript"></a>Tutorial de Introdução: um jogo UWP em JavaScript

## <a name="a-simple-2d-uwp-game-for-the-windows-store-written-in-javascript-and-createjs"></a>Um jogo simples 2D UWP para a Windows Store, escrito em JavaScript e CreateJS
...
**Observação:** este não é um jogo completo (nem bom!); ele foi projetado para demonstrar o uso de JavaScript e uma biblioteca de terceiros para deixar um app pronto para ser publicado na Windows Store.
...
Agora que você tem um aplicativo UWP, é possível publicá-lo na Windows Store (supondo que você o aperfeiçoou primeiro!) 
