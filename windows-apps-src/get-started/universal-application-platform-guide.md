...
Se você estiver criando um aplicativo Universal Windows Platform (UWP), em seguida, você pode obter muitos quilometragem e conveniência fora tratar os termos "plataforma universal do Windows (UWP)" e "Windows Runtime (WinRT)" como sinônimos mais ou menos. Mas *é* possível aparência nos bastidores da tecnologia e determinar apenas qual é a diferença entre essas ideias. Se você estiver curioso que, em seguida, essa última seção é para você.
