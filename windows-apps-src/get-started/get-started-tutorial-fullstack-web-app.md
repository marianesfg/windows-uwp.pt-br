---
author: libbymc
title: "Tutorial de Introdução - Aplicativo Web de página única com back-end da API REST"
description: Usar tecnologias da Web populares para criar um Aplicativo Web Hospedado para a Windows Store
...
Se você decidir alça em (ou adiar) a parte do Azure, basta ignorar as seções finais das partes I e II, que abrangem a hospedagem do Azure e o empacotamento do aplicativo para a Windows Store. O serviço de API e o aplicativo Web criado ainda serão executados localmente (em `http://localhost:8000` e `http://localhost:3000`, respectivamente) no computador.
...
Os documentos do Azure conduzirão você pelo(a):
 ...
 - [Registro de um novo *Aplicativo de API* com o Portal do Azure](https://docs.microsoft.com/en-us/azure/app-service-api/app-service-api-nodejs-api-app#a-idcreateapiappa-create-a-new-api-app)
 - [Configuração da implantação do Git no aplicativo de API](https://docs.microsoft.com/en-us/azure/app-service-api/app-service-api-nodejs-api-app#set-up-your-new-api-app-for-git-deployment) e
 - [Implantação do código do aplicativo de API no Azure](https://docs.microsoft.com/en-us/azure/app-service-api/app-service-api-nodejs-api-app#deploy-your-api-code-to-azure)
...
## <a name="part-ii-build-a-single-page-web-appl"></a>Parte II: Criar um aplicativo Web de página única
...
Aqui estão alguns recursos úteis para aprofundamento:
 ...
 - [Implantar o projeto de desenvolvimento de aplicativos para sites do Azure](https://docs.microsoft.com/en-us/azure/documentdb/documentdb-nodejs-application#a-nametoc395783182aPart-7-deploy-your-application-development-project-to-azure-websites)
