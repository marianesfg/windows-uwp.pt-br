---
title: "Tutorial de Introdução - um jogo UWP MonoGame 2D"
description: Um jogo UWP simples para a Windows Store, escrito em C# e MonoGame
author: mukin
ms.author: mukin
ms.date: 03/06/2017
ms.topic: article
...
translationtype: HT
---
# <a name="get-started-tutorial-a-uwp-game-in-monogame-2d"></a>Tutorial de Introdução: um jogo UWP em MonoGame 2D

## <a name="a-simple-2d-uwp-game-for-the-windows-store-written-in-c-and-monogame"></a>Um jogo UWP 2D simples para a Windows Store, escrito em C# e MonoGame
...
+    Windows 10 e Microsoft Visual Studio 2015. [Clique aqui para saber como fazer a preparação inicial com o Visual Studio](https://docs.microsoft.com/en-us/windows/uwp/get-started/get-set-up).
...
Abra o projeto no Visual Studio 2015 e pressione **F5** para executar o exemplo. A primeira vez que você fizer isso pode demorar um pouco, pois o Visual Studio precisa buscar qualquer pacote NuGet que esteja faltando na sua instalação.
...
Para o avatar do jogador, vamos usar o gato ninja da própria Microsoft, montado em seu amigo T-rex. [Clique aqui para baixar a imagem](https://github.com/muhsinking/VeggieJump/blob/master/MonoGame2D/Content/ninja-cat-dino.png).
...
7. Identificador de entrada do teclado - A seguir, precisamos de um novo método para manipular a entrada do usuário por meio do teclado. Adicione este método a **Game1.cs**:
...
## <a name="publish-to-the-windows-store"></a>Publicar na Windows Store
Como criamos este jogo como um aplicativo UWP, é possível publicar este projeto na Windows Store. Há algumas etapas para o processo.
...
Para obter mais detalhes, consulte [Publicando seu aplicativo da Windows Store](https://developer.microsoft.com/en-us/store/publish-apps).
