...
author: kbridge
ms.assetid: 
title: UWP Academy - Rastreamento de entrada - Suporte a tinta no aplicativo UWP
description: "UWP Academy. Rastreamento de entrada. Um tutorial passo a passo para adicionar suporte à tinta ao aplicativo UWP."
...
---
# <a name="support-ink-in-your-uwp-app"></a>Oferecer suporte à tinta em seu aplicativo UWP
...
Para obter mais detalhes sobre como implementar esses recursos, consulte [Interações da Caneta e Windows Ink nos aplicativos UWP](https://docs.microsoft.com/windows/uwp/input-and-devices/pen-and-stylus-interactions).
...
* [SDK do Windows 10 (10.0.15063.0)](https://developer.microsoft.com/en-US/windows/downloads/windows-10-sdk)
* Se você for novato no desenvolvimento de aplicativos UWP (Plataforma Universal do Windows) com o Visual Studio, dê uma olhada nestes tópicos antes de iniciar este tutorial:  
    * [Prepare-se para começar](https://docs.microsoft.com/en-us/windows/uwp/get-started/get-set-up)
    * [Criar um aplicativo "Olá, Mundo" (XAML)](https://docs.microsoft.com/en-us/windows/uwp/get-started/create-a-hello-world-app-xaml-universal)
...
> [!IMPORTANT]
> A maior parte do código no exemplo é comentada. À medida que percorremos cada etapa, você será solicitado a remover os comentários das várias seções do código. No Visual Studio, basta realçar as linhas de código, pressionar CTRL-K e, em seguida, CTRL-U.
...
3. Pressione F5 para compilar, implantar e executar.  
   ...
   > ![Botão de projeto Visual Studio Build](images/ink/ink-vsrun.png)
...
![Aplicativo vazio](images/ink/ink-app-step1-empty.png)
...
> [!NOTE]
> Um InkCanvas tem propriedades padrão [**Height**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement#Windows_UI_Xaml_FrameworkElement_Height) e [**Width**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement#Windows_UI_Xaml_FrameworkElement_Width) igual a zero, a menos que ele seja o filho de um elemento que dimensiona automaticamente seus elementos filhos. 
...
![Escrita à tinta básica](images/ink/ink-app-step1-name.png)
...
![InkToolbar no bloco de esboços do Espaço de Trabalho do Ink](images/ink/ink-inktoolbar-default.png)
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500>Aqui está um exemplo de um <strong><a href="https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.inktoolbar">InkToolbar</a></strong> personalizado (no bloco de esboços do Espaço de Trabalho do Windows Ink).

![InkToolbar no bloco de esboços do Espaço de Trabalho do Ink](images/ink/ink-inktoolbar-sketchpad.png)

Para obter mais detalhes sobre como personalizar um [**InkToolbar**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.inktoolbar), consulte [Adicionar um InkToolbar a um aplicativo de escrita à tinta UWP (Plataforma Universal do Windows)](https://docs.microsoft.com/en-us/windows/uwp/input-and-devices/ink-toolbar).
...
> ![InkToolbar no bloco de esboços do Espaço de Trabalho do Ink](images/ink/ink-settings-large.png)
> 3. Selecione **Conhecer meu manuscrito** para abrir a caixa de diálogo **Personalização de Manuscrito**.
> ![InkToolbar no bloco de esboços do Espaço de Trabalho do Ink](images/ink/ink-settings-handwritingpersonalization-large.png)
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500><p>O Windows Ink dá suporte ao reconhecimento de texto em muitos idiomas para os quais o Windows oferece suporte. Cada pacote de idiomas inclui um mecanismo de reconhecimento de manuscrito que pode ser instalado com o pacote de idiomas.</p>
    <p>Direcione um idioma específico consultando os mecanismos de reconhecimento de manuscrito instalados.</p>
    <p>Para obter mais detalhes sobre o reconhecimento de manuscrito internacional, consulte <a href="https://docs.microsoft.com/windows/uwp/input-and-devices/convert-ink-to-text">Reconhecer traços do Windows Ink como texto</a>.</p>
</tr>
</table>
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500><p>Neste tutorial, solicitamos que um botão seja pressionado para iniciar o reconhecimento. Você também pode executar o reconhecimento dinâmico usando uma função básica de sincronização.</p>

Para obter mais detalhes sobre o reconhecimento dinâmico, consulte [Reconhecer traços do Windows Ink como texto](https://docs.microsoft.com/en-us/windows/uwp/input-and-devices/convert-ink-to-text).
</tr>
</table>
...
![Fluxograma de tinta original](images/ink/ink-app-step6-shapereco1.png)

Este é o mesmo fluxograma após o reconhecimento de formas.

![Fluxograma de tinta original](images/ink/ink-app-step6-shapereco2.png)
...
<tr>
 <td width=125><img src="images/challenge-icon.png"></td>
    <td width=500><p>O Windows Ink também oferece suporte a cópia e colagem de traços de tinta de/para a área de transferência.

Para obter mais detalhes sobre como usar a área de transferência com tinta, consulte [Armazenar e recuperar dados de traço do Windows Ink](https://docs.microsoft.com/en-us/windows/uwp/input-and-devices/save-and-load-ink).
</tr>
</table>
...
* [Interações com caneta e Windows Ink em aplicativos UWP](https://docs.microsoft.com/windows/uwp/input-and-devices/pen-and-stylus-interactions)
