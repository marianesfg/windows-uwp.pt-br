...
### Relatório de erros (somente celular)
...
### Otimizações para Windows Explorer, Área de Trabalho Remota e PowerShell (somente desktop)
...
## Usar políticas de grupo ou chaves de registro para habilitar um dispositivo
...
## Atualizar seu dispositivo do Windows 8.1 para Windows 10
