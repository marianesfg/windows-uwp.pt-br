# [Referência RESTful para serviços Xbox Live](atoc-xboxlivews-reference.md)
# [Referência de URI (Universal Resource Identifier)](uri/atoc-xboxlivews-reference-uris.md)
...
## [URIs de imagem do jogador](uri/gamerpic/atoc-reference-gamerpic.md)
### [/users/me/gamerpic](uri/gamerpic/uri-usersmegamerpic.md)
#### [PUT (/users/me/gamerpic)](uri/gamerpic/uri-usersmegamerpicput.md)
## [URIs de placares de líderes](uri/leaderboard/atoc-reference-leaderboard.md)
...
## [URIs para organizar partida](uri/matchtickets/atoc-reference-matchtickets.md)
...
# [Enumerações usadas em objetos JSON (JavaScript Object Notation)](enums/atoc-xboxlivews-reference-enums.md)
## [Enumeração GameClipSource](enums/gvr-enum-gameclipsource.md)
