...
Baixa um arquivo. O domínio para esses URIs é `titlestorage.xboxlive.com`.
  ...
  * [Cabeçalhos de solicitação necessários](#ID4EZC)
  * [Cabeçalhos de solicitação opcionais](#ID4ECE)
  * [Corpo da solicitação](#ID4EMF)
  * [Códigos de status HTTP](#ID4EZF)
  * [Cabeçalhos de resposta](#ID4EMDAC)
  * [Corpo da resposta](#ID4EPEAC)
...
| type| cadeia de caracteres| O formato dos dados. Os valores possíveis são: binário, configuração ou json.| 
...
| customSelector| cadeia de caracteres| Para arquivos de tipo de configuração. Indica quais nós virtuais personalizados para incluir. Consulte o título do armazenamento para obter mais informações sobre arquivos de tipo de configuração.| 
