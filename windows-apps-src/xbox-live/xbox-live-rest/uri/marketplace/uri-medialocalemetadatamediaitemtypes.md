...
ms.locfileid: "57622611"
---
# <a name="mediamarketplaceidmetadatamediaitemtypes"></a>/media/{marketplaceId}/metadata/mediaItemTypes
Acessa todos os mediaItemTypes com suporte para a versão especificada da EDS. O domínio para esses URIs é `eds.xboxlive.com`.
...
[GET (/media/ {marketplaceId} / metadados/mediaItemTypes)](uri-medialocalemetadatamediaitemtypesget.md)

&nbsp;&nbsp;Lista todos os mediaItemTypes com suporte para a versão especificada da EDS.
