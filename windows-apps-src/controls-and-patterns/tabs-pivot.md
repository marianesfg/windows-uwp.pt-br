...
> **APIs importantes**: [classe Pivot](https://msdn.microsoft.com/library/windows/apps/dn608241)
...
- **Navegação de nível superior ou inferior.**  Pivôs podem ser usados em qualquer nível de navegação. O [painel de navegação](navigationview.md) também pode servir como o nível principal com pivôs funcionando como o nível secundário.
...
> Observação&nbsp;&nbsp; cabeçalhos de pivô devem não carrossel em um [ambiente de 3 metros](../input-and-devices/designing-for-tv.md). Defina a nova propriedade [IsHeaderItemsCarouselEnabled](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Pivot#Windows_UI_Xaml_Controls_Pivot_IsHeaderItemsCarouselEnabled) como **false** se o aplicativo for executado no Xbox.
...
Aplicativos que personalizaram Pivot e incorporam o sublinhado em elementos visuais de seleção do cabeçalho podem usar a nova propriedade [HeaderFocusVisualPlacement](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.pivot#Windows_UI_Xaml_Controls_Pivot_HeaderFocusVisualPlacement) para alterar o padrão. Quando `HeaderFocusVisualPlacement="ItemHeaders"`, o foco será desenhado ao redor de todo o painel do cabeçalho.
