...
A fonte **Segoe UI Symbol** ainda estará disponível como recurso "herdado". Mas é recomendável que todos os aplicativos sejam atualizados para usar a nova fonte **Segoe MDL2 Assets**.
...
Se você estiver trabalhando com blocos, não poderá usar esses glifos porque não é possível especificar a fonte de bloco e os glifos da PUA não são disponibilizados via fallback de fonte.
...
A fonte Segoe UI Symbol também dependia de glifos de "largura zero" para a divisão em camadas e a colorização, como neste exemplo, um contorno preto (U + E006) poderia ser desenhado sobre o coração vermelho de largura zero (U + E00B).

![usando glifo de largura zero](images/segoe-ui-symbol-layering.png)

Todos os glifos na fonte **Segoe MDL2 Assets** têm a mesma largura fixa com uma altura consistente e ponto de origem à esquerda, portanto, as camadas e os efeitos de colorização podem ser obtidos, desenhando glifos diretamente um em cima do outro.
...
Se você está desenvolvendo um aplicativo em C#/VB/C++ e XAML, pode optar por usar [**Symbol enumeration**](https://msdn.microsoft.com/library/windows/apps/dn252842) no lugar da ID do Unicode para especificar glifos da fonte Segoe MDL2 Assets. Se você está desenvolvendo um aplicativo em JavaScript e HTML, pode optar por usar a [**enumeração AppBarIcon**](https://msdn.microsoft.com/library/windows/apps/hh770557) no lugar da ID do Unicode para especificar glifos da fonte **Segoe MDL2 Assets**.

Além disso, tenha em mente que a fonte **Segoe MDL2 Assets** inclui muito mais ícones do que podemos mostrar aqui. Muitos desses são destinados a finalidades específicas e não são normalmente usados em qualquer outro lugar.

## <span id="Hearts"></span><span id="hearts"></span><span id="HEARTS"></span>Corações
...
<td align="left"><p>Coração contornado</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Coração sólido</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>Coração partido</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Coração sólido (largura zero)</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>Coração partido (largura zero)</p></td>
</tr>
</tbody>
</table>
...
## <span id="Rating_stars"></span><span id="rating_stars"></span><span id="RATING_STARS"></span>Estrelas de classificação
...
<td align="left">Estrela contornada</td>
</tr>
<tr class="even">
...
<td align="left">Estrela sólida</td>
</tr>
<tr class="odd">
...
<td align="left">Estrela sólida (largura zero)</td>
</tr>
<tr class="even">
...
<td align="left">Estrela sólida (preenchimento reduzido para uso em HTML)</td>
</tr>
<tr class="odd">
...
<td align="left">Meia estrela, lado direito</td>
</tr>
</tbody>
</table>
...
## <span id="Checkbox_components"></span><span id="checkbox_components"></span><span id="CHECKBOX_COMPONENTS"></span>Componentes da caixa de seleção


|        |                                                                                |                                 |                         |
|--------|--------------------------------------------------------------------------------|---------------------------------|-------------------------|
| Código   | Símbolo                                                                         | Enumeração                            | Descrição             |
| U+E001 | ![checkmarklegacy](images/checkmarklegacy.png)                                 | CheckMarkLegacy                 | Marca de seleção              |
| U+E002 | ![checkboxfilllegacy](images/checkboxfilllegacy.png)                           | CheckboxFillLegacy              | Caixa de seleção preenchida         |
| U+E003 | ![checkboxlegacy](images/checkboxlegacy.png)                                   | CheckboxLegacy                  | Caixa de seleção                |
...
| U+E005 | ![checkboxcompositereversedlegacy](images/checkboxcompositereversedlegacy.png) | CheckboxCompositeReversedLegacy | Inversão                |
...
| U+E73D | ![checkboxcompositereversed](images/checkboxcompositereversed.png)             | CheckboxCompositeReversed       | Composição invertida      |
| U+E73E | ![checkmark](images/checkmark.png)                                             | CheckMark                       | Marca de seleção              |

 

## <span id="Miscellaneous"></span><span id="miscellaneous"></span><span id="MISCELLANEOUS"></span>Diversos
...
<td align="left">Favorito contornado</td>
</tr>
<tr class="odd">
...
<td align="left">EmailMensagemLegacy</td>
<td align="left">Herdado de email</td>
</tr>
<tr class="odd">
...
<td align="left">Favorito preenchido</td>
</tr>
<tr class="odd">
...
<td align="left">MobileContatoLegacy</td>
<td align="left">Contato móvel</td>
</tr>
<tr class="odd">
...
<td align="left">Contato bloqueado</td>
</tr>
<tr class="even">
...
<td align="left">Indicador de digitação</td>
</tr>
<tr class="odd">
...
<td align="left">PresenceChickletVídeoLegacy</td>
<td align="left">Chicklet de presença de vídeo</td>
</tr>
<tr class="even">
...
<td align="left">Chicklet de presença</td>
</tr>
</tbody>
</table>
...
## <span id="Scroll_bar_arrows"></span><span id="scroll_bar_arrows"></span><span id="SCROLL_BAR_ARROWS"></span>Setas da barra de rolagem


| Código   | Símbolo                                                                   | Enumeração                         |
|--------|--------------------------------------------------------------------------|------------------------------|
...
## <span id="Back_buttons"></span><span id="back_buttons"></span><span id="BACK_BUTTONS"></span>Botões Voltar


Os glifos herdados para os botões Voltar estão disponíveis em dois tamanhos diferentes, para que a espessura do anel externo seja consistente com os tamanhos de 20 e 42 pontos. Dois novos botões Voltar cromados proporcionais também estão disponíveis. Esses glifos foram projetados para dar suporte à divisão em camadas.

| Código   | Símbolo                                                                     | Enumeração                          | Descrição                               |
|--------|----------------------------------------------------------------------------|-------------------------------|-------------------------------------------|
| U+E0C4 | ![backbttnarrow20legacy](images/backbttnarrow20legacy.png)                 | BackBttnArrow20Legacy         | Seta do botão Voltar, 20 pt                   |
| U+E0A6 | ![backbttnarrow42legacy](images/backbttnarrow42legacy.png)                 | BackBttnArrow42Legacy         | Seta do botão Voltar, 42 pt                   |
| U+E0AD | ![backbttnmirroredarrow20legacy](images/backbttnmirroredarrow20legacy.png) | BackBttnMirroredArrow20Legacy | Seta do botão Voltar espelhada invertida, 20 pt |
| U+E0AB | ![backbttnmirroredarrow42legacy](images/backbttnmirroredarrow42legacy.png) | BackBttnMirroredArrow42Legacy | Seta do botão Voltar espelhada invertida, 42 pt |
| U+E830 | ![chromeback](images/chromeback.png)                                       | ChromeBack                    | Botão Voltar do Chrome                        |
| U+EA47 | ![chromebackmirrored](images/chromebackmirrored.png)                       | ChromeBackMirrored            | Botão Voltar do Chrome espelhado               |

 

## <span id="Back_arrows_for_HTML"></span><span id="back_arrows_for_html"></span><span id="BACK_ARROWS_FOR_HTML"></span>Setas Voltar para HTML


Use um código adicional para criar círculos ao redor desses glifos.

| Código   | Símbolo                                                         | Enumeração                    | Descrição                |
|--------|----------------------------------------------------------------|-------------------------|----------------------------|
| U+E0D5 | ![arrowhtmllegacy](images/arrowhtmllegacy.png)                 | ArrowHTMLLegacy         | Seta para uso em HTML         |
| U+E0AE | ![arrowhtmlmirroredlegacy](images/arrowhtmlmirroredlegacy.png) | ArrowHTMLMirroredLegacy | Versão espelhada de U + E0D5 |
...
<td align="left">FonteDecrease</td>
<td align="left"></td>
</tr>
<tr class="even">
...
## <span id="Battery_icons"></span><span id="battery_icons"></span><span id="BATTERY_ICONS"></span>Ícones de bateria


| Código | Símbolo                                             | Enumeração              | Código | Símbolo                                                  | Enumeração                |
|------|----------------------------------------------------|-------------------|------|---------------------------------------------------------|---------------------|
