...
---
# Layout hierárquico com TreeView
...
## Estrutura da interface do usuário do TreeView
...
#### Linhas vermelhas para recuo de pastas e nós que não são de pasta
...
## Criar um modelo de dados para seu TreeViewItem
...
## Configurar os dados em seu TreeView
