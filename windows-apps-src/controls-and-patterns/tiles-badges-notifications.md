...
label: Blocos, selos e notificações
template: detail.hbs
---
...
<td align="left"><p>Visualizador de Notificações é um novo aplicativo da Plataforma Universal do Windows (UWP) na [the Store](https://www.microsoft.com/store/apps/notifications-visualizer/9nblggh5xsl1) que ajuda os desenvolvedores no design de blocos dinâmicos adaptáveis para Windows 10.</p></td>
</tr>
<tr class="odd">
