...
* [
            ...
            ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.iskeyboardfocusablecore): retornará **true** se o proprietário for um [**Control**](https://msdn.microsoft.com/library/windows/apps/BR209390); caso contrário, será **false**.
* [
              **IsOffscreenCore**
...
* [
              **SetFocusCore**
            ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.setfocuscore): chama [**Focus**](https://msdn.microsoft.com/library/windows/apps/hh702161).
* [
              **GetParent**
