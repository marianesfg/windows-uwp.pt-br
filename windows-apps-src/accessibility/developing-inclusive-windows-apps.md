---
Description: Uma estratégia para desenvolver aplicativos UWP (Plataforma Universal do Windows) acessíveis.
title: Desenvolvendo aplicativos inclusivos do Windows
