...
A extensão de marcação **{x: Bind}** — nova para Windows 10 — é uma alternativa para **{Binding}**. **{x: Bind}** é executado em menos tempo e usando menos memória do que **{Binding}** e suporta melhor a depuração.
