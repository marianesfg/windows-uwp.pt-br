---
description:Apresentamos a linguagem XAML e os conceitos de XAML para a audiência de desenvolvedores de aplicativos do Windows Runtime e descrevemos as diferentes maneiras de declarar objetos e definir atributos no XAML durante seu uso para criar um aplicativo do Windows Runtime.
...
Apresentamos a linguagem XAML e os conceitos de XAML para a audiência de desenvolvedores de aplicativos do Windows Runtime e descrevemos as diferentes maneiras de declarar objetos e definir atributos no XAML durante seu uso para criar um aplicativo do Windows Runtime.
...
-   [{Binding}](binding-markup-extension.md): permite a vinculação de dados, que adia a avaliação de propriedade até o tempo de execução, executando a inspeção de objeto no tempo de execução de finalidade geral. Essa extensão de marcação permite uma ampla variedade de argumentos.
...
O Windows Runtime também permite a extensão de marcação [{x:Null}](x-null-markup-extension.md). Use-a para definir valores de [**Nullable**](T:System.Nullable%601) como **null** em XAML. Por exemplo, você pode usá-la em um modelo de controle para uma [**CheckBox**](https://msdn.microsoft.com/library/windows/apps/br209316), que interpreta **null** como um estado de verificação indeterminado (disparando o estado visual "Indeterminado").
...
## Otimizar o XAML para desempenho de carga
