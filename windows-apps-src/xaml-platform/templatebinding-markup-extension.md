...
Neste exemplo, a propriedade **Text** é avaliada como **Button.Content.ToString**. O TargetType em ControlTemplate atua como a fonte de dados e realize o mesmo resultado como um TemplateBinding pai.
