...
* Para aplicativos WPF e Windows Forms, recomendamos que você use os [controles de host](xaml-host-controls.md#host-controls) e [controles empacotados](xaml-host-controls.md#wrapped-controls) no Kit de ferramentas de comunidade do Windows em vez do XAML da UWP que hospeda a API. Esses controles usam o XAML da UWP que hospeda a API internamente e fornecem uma experiência de desenvolvimento mais simples. No entanto, você pode usar o XAML da UWP que hospeda API diretamente nesses tipos de aplicativos, se você escolher.

## <a name="related-samples"></a>Exemplos relacionados

Depende da maneira que você usa o XAML da UWP que hospeda a API em seu código em seu tipo de aplicativo, o design do seu aplicativo e de outros fatores. Para ilustrar como usar essa API no contexto de um aplicativo completo, este artigo se refere ao código dos exemplos a seguir.

### <a name="c-win32"></a>C++ Win32

Há vários exemplos que demonstram como usar o XAML da UWP que hospeda a API em um aplicativo Win32 do C++ no GitHub:

  * [XamlHostingSample](https://github.com/Microsoft/Windows-appsample-Xaml-Hosting). Este exemplo demonstra como adicionar os controles UWP [InkCanvas](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.inkcanvas), [InkToolbar](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.inktoolbar)e [MediaPlayerElement](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.mediaplayerelement) para um aplicativo Win32 do C++.
...
> [!IMPORTANT]
> Atualmente, controles personalizados de XAML da UWP de partes 3ª só têm suporte em aplicativos c# WPF e Windows Forms. Você deve ter o código-fonte para os controles, portanto, você pode compilar em relação a ele em seu aplicativo.
