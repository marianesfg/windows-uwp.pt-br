...
* Para aplicativos WPF e Windows Forms, recomendamos que você use os [controles empacotados](xaml-host-controls.md#wrapped-controls) e [hospedar controles](xaml-host-controls.md#host-controls) no Kit de ferramentas de comunidade do Windows em vez do XAML da UWP que hospeda a API. Esses controles usam o XAML da UWP que hospeda API internamente e proporcionar uma experiência de desenvolvimento mais simples. No entanto, você pode usar o XAML da UWP que hospeda API diretamente nesses tipos de aplicativos, se você escolher.

## <a name="related-samples"></a>Exemplos relacionados

Da maneira que você usa o XAML da UWP que hospeda a API em seu código depende do seu tipo de aplicativo, o design do seu aplicativo e de outros fatores. Para ilustrar como usar essa API no contexto de um aplicativo completo, este artigo se refere ao código dos exemplos a seguir.

### <a name="c-win32"></a>C++ Win32

Há vários exemplos que demonstram como usar o XAML da UWP que hospeda a API em um aplicativo Win32 de C++ no GitHub:
...
Quando você cria uma ilha XAML usando o XAML que hospeda a API em um aplicativo da área de trabalho, você terá a seguinte hierarquia de objetos:
...
> [!IMPORTANT]
> Atualmente, controles personalizados de XAML da UWP de partes 3ª só têm suporte em aplicativos c# WPF e Windows Forms. Você deve ter o código-fonte para os controles para que você pode compilar em relação a ele em seu aplicativo.
