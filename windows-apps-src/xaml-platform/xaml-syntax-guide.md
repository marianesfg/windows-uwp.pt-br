...
-   Elementos filho podem informar painéis do contêiner pai como deve se comportar em layout: [**Tela**](https://msdn.microsoft.com/library/windows/apps/br209267), [ **grade**](https://msdn.microsoft.com/library/windows/apps/br242704), [ **VariableSizedWrapGrid**](https://msdn.microsoft.com/library/windows/apps/br227651).
