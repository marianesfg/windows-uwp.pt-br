---
description: Explica como definir e implementar propriedades de dependência personalizadas para um aplicativo do Tempo de Execução do Windows em C++, C# ou Visual Basic.
