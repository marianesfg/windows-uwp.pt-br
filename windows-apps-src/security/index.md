---
title: Segurança
description: Esta seção contém artigos sobre como criar aplicativos da Plataforma Universal do Windows (UWP) seguros para o Windows 10.
