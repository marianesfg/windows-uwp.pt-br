...
| Codificando                    | O processo de codificar mensagens digitais, incluindo certificados, para transporte por uma rede.                                                                                                     |
...
| [Chaves de criptografia](cryptographic-keys.md)                                   | Este artigo mostra como usar funções de derivação de chaves padrão para derivar chaves e como criptografar conteúdo usando chaves simétricas e assimétricas.                                                                                                                                                                                                                                                                                                                                                                             |
