...
Para obter um exemplo de código completo, consulte [Exemplo de código do Windows Hello no GitHub](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/MicrosoftPassport).
