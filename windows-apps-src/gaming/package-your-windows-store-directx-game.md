...
## Definindo pacotes de recursos de idiomas localizados
...
## Definição do fator de dimensionamento dos pacotes de recursos
...
## Definição do nível de recursos do DirectX dos pacotes de recursos
