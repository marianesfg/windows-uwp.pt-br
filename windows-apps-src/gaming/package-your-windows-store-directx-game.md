...
Jogos da Plataforma Universal do Windows (UWP) maiores, principalmente os que dão suporte a vários idiomas com ativos específicos de região ou oferecem ativos de alta definição opcionais, podem inflar para tamanhos maiores. Neste tópico, você aprenderá a usar pacotes e lotes de apps para personalizar seu app de forma que os clientes recebam apenas os recursos que eles realmente precisam.

Além do modelo de pacote do app, o Windows 10 oferece suporte para lotes de app que agrupam dois tipos de pacotes:

-   Pacotes de apps que contêm arquivos executáveis e bibliotecas específicos da plataforma. Tipicamente, um jogo UWP pode ter até três pacotes de app: um para cada arquitetura x86, x64 e CPU ARM. Todos os códigos e dados específicos da plataforma de hardware em questão deverão estar incluídos nesse pacote do app. O pacote do app também deve conter todos os principais ativos para que o jogo seja executado com um nível básico de fidelidade e desempenho.
...
Ao configurar seu app para dar suporte a ativos localizados para vários idiomas:

-   Crie um subdiretório de app (ou uma versão de arquivo) para cada idioma e localidade a que você oferecerá suporte (por exemplo, en-us, jp-jp, zh-cn, fr-fr e assim por diante).
...
Quando estiver configurando seu app para oferecer suporte a pacotes de recursos para diferentes fatores de escala de app UWP, você deve:

-   Crie um subdiretório do app (ou versão do arquivo) para cada fator de dimensionamento ao qual você dará suporte (escala-100, escala-140 e escala-180).
...
-   No Visual Studio 2015, selecione **PROJETO->Loja->Criar pacote do app...** e crie o pacote.
...
Seu pacote do app básico deve usar os formatos básicos de compactação de textura: BC1, BC2 ou BC3. Esses formatos podem ser consumidos por qualquer dispositivo UWP, desde plataformas ARM inferiores até estações de trabalho multi-GPU dedicadas e computadores de mídia.
...
Ao configurar seu app para dar suporte a pacotes de recursos de diferentes níveis de recursos do DirectX:

-   Crie um subdiretório do app (ou versão do arquivo) para cada nível de recursos do DirectX ao qual você dará suporte (dxfl-dx9, dxfl-dx10 e dxfl-dx11).
...
-   No Visual Studio 2015, selecione **PROJETO->Loja->Criar pacote do app...** e crie o pacote.
-   Certifique-se de ativar lotes de app nas configurações de manifesto package.appxmanifest.

## <a name="related-topics"></a>Tópicos relacionados


* [Definindo recursos de app](https://msdn.microsoft.com/library/windows/apps/xaml/hh965321)
* [Empacotando apps](https://msdn.microsoft.com/library/windows/apps/mt270969)
* [Empacotador de app (MakeAppx.exe)](https://msdn.microsoft.com/library/windows/desktop/hh446767)
