...
<div class="alert">
<strong>Observação</strong>  As coordenadas do [<strong>CoreWindow</strong>](https://msdn.microsoft.com/library/windows/desktop/hh404559) são em DIPs (pixels independentes de dispositivo) para [Direct2D](https://msdn.microsoft.com/library/windows/desktop/dd370987). Como resultado, você deve notificar o Direct2D sobre a alteração no DPI para exibir quaisquer ativos ou primitivas 2D corretamente.
</div>
<div>
</div></td>
</tr>
