...
> **Observação**    aplicativos de área de trabalho do Windows apresentam diferentes APIs para a obtenção de uma cadeia de troca do Direct3D, tais como [ **D3D11Device::CreateDeviceAndSwapChain**](https://msdn.microsoft.com/library/windows/desktop/ff476083)e não use um [ **CoreWindow** ](https://msdn.microsoft.com/library/windows/apps/br208225) objeto.
...
Depois de obtida a referência a [**CoreWindow**](https://msdn.microsoft.com/library/windows/apps/br208225), a janela deve ser ativada, o que executa o método **Run** do seu objeto principal e inicia o processamento do evento de janela. Depois disso, crie uma [ **ID3D11Device1** ](https://msdn.microsoft.com/library/windows/desktop/hh404575) e um [ **ID3D11DeviceContext1**](https://msdn.microsoft.com/library/windows/desktop/hh404598)e usá-los para obter subjacente [ **IDXGIDevice1** ](https://msdn.microsoft.com/library/windows/desktop/ff471331) e [ **IDXGIAdapter** ](https://msdn.microsoft.com/library/windows/desktop/bb174523) para que você possa obter um [ **IDXGIFactory2** ](https://msdn.microsoft.com/library/windows/desktop/hh404556) objeto para criar um recurso de cadeia de troca com base no seu [ **DXGI\_troca\_cadeia\_DESC1** ](https://msdn.microsoft.com/library/windows/desktop/hh404528) configuração.
...
Observe que em Direct3D 11, não há uma abstração idêntica a EGLSurface. (Há [ **IDXGISurface1**](https://msdn.microsoft.com/library/windows/desktop/ff471343), mas ele é usado de forma diferente.) O mais próximo conceitual é o [ **ID3D11RenderTargetView** ](https://msdn.microsoft.com/library/windows/desktop/ff476582) que usamos para atribuir uma textura de objeto ([**ID3D11Texture2D** ](https://msdn.microsoft.com/library/windows/desktop/ff476635)) como o buffer de fundo que nosso pipeline sombreador desenhará em.
...
Em Direct3D 11, você cria um recurso [**ID3D11Texture2D**](https://msdn.microsoft.com/library/windows/desktop/ff476635) e o transforma em um destino de renderização. Configurar o destino de renderização usando [ **D3D11\_RENDERIZAR\_destino\_exibição\_DESC**](https://msdn.microsoft.com/library/windows/desktop/ff476201). Quando você chama o [ **ID3D11DeviceContext::Draw** ](https://msdn.microsoft.com/library/windows/desktop/ff476407) método (ou um desenho semelhante\* operação no contexto de dispositivo) usando este destino de renderização, os resultados são desenhados em uma textura.
...
Em Direct3D 11, configure seus buffers e vincule sombreadores com a sua [**IDXGISwapChain::Present1**](https://msdn.microsoft.com/library/windows/desktop/hh446797). Em seguida, chamar um dos [ **ID3D11DeviceContext1::Draw** ](https://msdn.microsoft.com/library/windows/desktop/ff476407) \* métodos para executar os sombreadores e desenhar os resultados para um destino de renderização configurado como o buffer de fundo da cadeia de troca. Depois disso, basta apresentar o buffer de fundo para a exibição chamando **IDXGISwapChain::Present1**.
...
| eglSurfaceAttrib                 | Use [ **D3D11\_RENDERIZAR\_destino\_exibição\_DESC** ](https://msdn.microsoft.com/library/windows/desktop/ff476201) para configurar uma exibição de destino de renderização do Direct3D,                                                                                                                                                                                                                                                                                                                                                               |
