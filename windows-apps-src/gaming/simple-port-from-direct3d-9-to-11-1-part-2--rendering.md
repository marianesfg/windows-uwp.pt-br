...
> **Observação**  
As regras de associação dos sombreadores de vértice aos sombreadores de pixel no Direct3D 9 eram mais flexíveis que as do Direct3D 11. A organização do Direct3D 9 era flexível, mas ineficiente.
