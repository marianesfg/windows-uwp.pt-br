...
| [Redimensionamento e sobreposições da cadeia de troca](multisampling--scaling--and-overlay-swap-chains.md) | Saiba como criar cadeias de troca redimensionadas para permitir renderização mais rápida em dispositivos móveis e usar cadeias de troca sobrepostas (quando disponíveis) para aumentar a qualidade visual. |
