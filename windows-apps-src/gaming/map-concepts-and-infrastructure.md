...
Ao iniciar o processo de portabilidade da arquitetura gráfica do OpenGL ES 2.0 para o Direct3D pela primeira vez, familiarize-se com as principais diferenças entre APIs. Os tópicos nesta seção o ajudam a planejar a estratégia de potabilidade e as mudanças de API que você deve fazer ao mudar o processamento gráfico para o Direct3D.
## 
<table>
<colgroup>
<col width="50%" />
...
<td align="left"><p>A DXGI (interface gráfica do DirectX) e diversas APIs Direct3D têm a mesma função do EGL. Este tópico o ajudar a entender a DXGI e o Direct3D 11 do ponto de vista do EGL.</p></td>
</tr>
<tr class="odd">
