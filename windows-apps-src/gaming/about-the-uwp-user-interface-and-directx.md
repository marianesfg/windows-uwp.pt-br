...
Consulte o [Glossário de elementos gráficos do Direct3D](../graphics-concepts/index.md) para obter informações sobre termos familiarizado gráficos ou conceitos encontrados durante a leitura.
