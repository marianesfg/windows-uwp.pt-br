...
##  Por que criar jogos acessíveis?

### Base maior de jogadores
...
##  O jogo que você está criando hoje é acessível?
...
## Como criar jogos mais acessíveis?

### Mudança de design: abordagem do design de jogo inclusivo
...
### Evangelizar: fazer da acessibilidade uma prioridade no estúdio de jogos
...
### Revisar: avaliar constantemente o jogo
...
### Testar e iterar: ouvir comentários dos jogadores
...
### Anunciar: dizer ao mundo que o jogo é acessível
...
### Gráficos e interface de usuário amigáveis para daltônicos
...
### Teste de epilepsia para fotossensibilidade
