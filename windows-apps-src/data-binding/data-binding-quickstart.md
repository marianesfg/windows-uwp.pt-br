...
Adicione uma nova classe ao seu projeto, chame-a de Recording.cs (se você também estiver usando snippets C#, C + + fornecidos abaixo) e adicione este código a ela.
