...
## <a name="step-0-ensure-unity-is-installed-correctly"></a>Etapa 0: Certifique-se de que Unity está instalado corretamente
...
## <a name="step-1-building-the-uwp-solution"></a>Etapa 1: Compilando a solução UWP
...
## <a name="step-2-deploying-your-game"></a>Etapa 2: Implantando seu jogo
...
## <a name="step-3-modify-and-rebuild"></a>Etapa 3: Modificar e recompilar
