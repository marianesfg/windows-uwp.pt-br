...
> [!NOTE]
> Para saber como objetos [XamlLight](/uwp/api/windows.ui.xaml.media.xamllight) aplicam [CompositionLights](/uwp/api/Windows.UI.Composition.CompositionLight) para iluminar UIElements XAML, consulte [iluminação XAML](xaml-lighting.md).
...
Veja a amostra de [Texto tremida](https://github.com/Microsoft/WindowsUIDevLabs/tree/master/SampleGallery/Samples/SDK%2014393/TextShimmer) completa no galé de exemplo WindowUIDevLabs para saber mais.
...
Conceito | Detalhes
--- | ---
**A luz ambiente** | Adicionando um não-a luz a sua cena desativará todas as luzes existentes.  Itens não direcionados por um não-a luz aparecerá em pretos.  Para iluminar elementos visuais ao redor de destino não a luz de uma maneira natural, use uma luz ambiente em conjunto com outras luzes.
...
**Transformações** | As luzes devem ser colocadas em um nó acima da interface do usuário que usa efeitos, como [transformações de perspectiva](/design/layout/3-d-perspective-effects.md) na sua estrutura visual a ser desenhada corretamente.
