...
ms.locfileid: "58174035"
---
# <a name="using-the-visual-layer-with-windows-forms"></a>Usando a camada Visual com o Windows Forms

Você pode usar as APIs de composição de tempo de execução do Windows (também chamado de [camada Visual](visual-layer.md)) em seus aplicativos do Windows Forms para criar experiências modernas ou luz para os usuários do Windows 10.
...
![O interface do usuário do aplicativo em execução](images/interop/wf-comp-interop-app-ui.png)
