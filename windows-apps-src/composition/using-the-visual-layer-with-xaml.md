...
Veja a seção [**Pincéis**](../graphics/using-brushes.md#xamlcompositionbrushbase) para saber mais sobre o uso de pincéis com a interface do usuário XAML.
...
Veja a seção [**Iluminação**](lighting.md) para saber mais sobre o uso de luzes, incluindo os elementos da interface do usuário XAML de iluminação.
...
Este é o equivalente a [C++/CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx) do código C&#35; anterior usando a mesma estrutura XAML.
