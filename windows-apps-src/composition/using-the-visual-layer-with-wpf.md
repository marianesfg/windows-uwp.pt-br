...
ms.locfileid: "58174036"
---
# <a name="using-the-visual-layer-with-wpf"></a>Usando a camada Visual com o WPF

Você pode usar as APIs de composição de tempo de execução do Windows (também chamado de [camada Visual](visual-layer.md)) em seus aplicativos do Windows Presentation Foundation (WPF) para criar experiências modernas ou luz para os usuários do Windows 10.
...
![O interface do usuário do aplicativo em execução](images/interop/wpf-comp-interop-app-ui.png)
