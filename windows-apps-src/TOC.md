...
### [Criar um aplicativo Hello, world (JS)](get-started/create-a-hello-world-app-js-uwp.md)
### [Criar um aplicativo "Olá, mundo" (C++)](get-started/create-a-basic-windows-10-app-in-cpp.md)
### [Oferecer suporte a tinta em seu aplicativo UWP](get-started/ink-walkthrough.md)
### [Oferecer suporte ao Surface Dial (e outros dispositivos de rolagem) em seu aplicativo UWP](get-started/radialcontroller-walkthrough.md)
### [Um aplicativo web de página única + API REST](get-started/get-started-tutorial-fullstack-web-app.md)
### [Um jogo UWP 2D em JavaScript](get-started/get-started-tutorial-game-js2d.md)
### [Um jogo UWP 3D em JavaScript](get-started/get-started-tutorial-game-js3d.md)
### [Um jogo UWP em MonoGame](get-started/get-started-tutorial-game-mg2d.md)
### [Adicionando WebVR a um jogo de Babylon.js](get-started/adding-webvr-to-a-babylonjs-game.md)
...
#### [Implementar a navegação básica](layout/navigate-between-two-pages.md)
#### [Oferecer suporte a histórico e navegação regressiva](layout/navigation-history-and-backwards-navigation.md)
...
### [Movimento e animação](style/motion.md)
#### [Animação conectada](style/connected-animation.md)
#### [Transição de conteúdo](style/content-transition-animations.md)
#### [Adicionar e excluir](style/motion-list.md)
#### [Fade](style/motion-fade.md)
#### [Pressione feedback](style/motion-pointer.md)
### [Paralaxe](style/parallax.md)
### [Revelar](style/reveal.md)
### [Som](style/sound.md)
...
### [Botão de rádio](controls-and-patterns/radio-button.md)
...
##### [Diretrizes de ativos de blocos e ícones](controls-and-patterns/tiles-and-notifications-app-assets.md)
##### [Blocos secundários](controls-and-patterns/tiles-and-notifications-secondary-tiles.md)
###### [Diretrizes](controls-and-patterns/tiles-and-notifications-secondary-tiles-guidance.md)
###### [Fixar blocos secundários](controls-and-patterns/tiles-and-notifications-secondary-tiles-pinning.md)
###### [Aplicativos da área de trabalho](controls-and-patterns/tiles-and-notifications-secondary-tiles-desktop-pinning.md)
##### [Conteúdo do bloco](controls-and-patterns/tiles-and-notifications-create-adaptive-tiles.md)
##### [Esquema de conteúdo do bloco](controls-and-patterns/tiles-and-notifications-adaptive-tiles-schema.md)
##### [Modelos de blocos especiais](controls-and-patterns/tiles-and-notifications-special-tile-templates-catalog.md)
##### [Enviar uma notificação de bloco local](controls-and-patterns/tiles-and-notifications-sending-a-local-tile-notification.md)
##### [APIs de bloco primário](controls-and-patterns/tiles-and-notifications-primary-tile-apis.md)
#### [Fixar seu aplicativo na barra de tarefas](controls-and-patterns/pin-to-taskbar.md)
#### [Notificações do sistema](controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts.md)
##### [Conteúdo da notificação do sistema](controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts.md)
##### [Esquema de conteúdo de notificação do sistema](controls-and-patterns/tiles-and-notifications-toast-schema.md)
##### [Enviar notificação local do sistema](controls-and-patterns/tiles-and-notifications-send-local-toast.md)
...
#### [Métodos de entrega de notificações](controls-and-patterns/tiles-and-notifications-choosing-a-notification-delivery-method.md)
##### [Tipos de canal de notificação](controls-and-patterns/tiles-and-notifications/channel-types.md)
...
### [Exibição em árvore ](controls-and-patterns/tree-view.md)
...
##### [Interações por teclado personalizadas](input-and-devices/custom-keyboard-interactions.md)
##### [Eventos de teclado](input-and-devices/keyboard-events.md)
...
#### [Gerenciando a navegação de foco](input-and-devices/managing-focus-navigation.md)
...
#### [Migrar recursos herdados](globalizing/using-mrt-for-converted-desktop-apps-and-games.md)
### [Diretrizes da ajuda do aplicativo](in-app-help/guidelines-for-app-help.md)
...
## [Sistema de Design Fluent](http://fluent.microsoft.com/)
## [Kits de ferramentas de design](design-downloads/index.md)
# Desenvolver aplicativos do Windows
## [Novidades no Windows 10 para desenvolvedores, versão 1703](whats-new/windows-10-version-latest.md)
### [Adições de API no Windows 10, versão 1703](whats-new/windows-10-version-1703-api-diff.md)
### [APIs de pré-lançamento na Compilação 16257 de Prévia SDK do Windows 10](whats-new/windows-10-latest-preview-api-diff.md)
### [Novidades da Compilação de Prévia 2017 do Windows 10](whats-new/windows-10-build-16190.md)
...
## [Novidades dos documentos do Windows, agosto de 2017](whats-new/windows-docs-latest.md)
### [Novidades dos documentos do Windows, julho de 2017](whats-new/windows-docs-july-2017.md)
## [Comunicação entre aplicativos](app-to-app/index.md)
...
### [Entity Framework Core com SQLite para apps C#](data-access/entity-framework-7-with-sqlite-for-csharp-apps.md)
...
#### [Criar um plug-in personalizado para o Device Portal](debug-test-perf/device-portal-plugin.md)
...
#### [Introdução ao POS](devices-sensors/pos-get-started.md)
#### [Suporte a dispositivo POS](devices-sensors/pos-device-support.md)
...
#### [Implantar os perfis do scanner de código de barras](devices-sensors/deploy-scanner-profiles-with-mdm.md)
...
#### [Objeto de aplicativo](gaming/about-the-metro-style-user-interface-and-directx.md)
...
#### [Jogo simples de UWP](gaming/tutorial--create-your-first-metro-style-directx-game.md)
##### [Configurar o projeto](gaming/tutorial--setting-up-the-games-infrastructure.md)
##### [Estrutura UWP](gaming/tutorial--building-the-games-metro-style-app-framework.md)
##### [Objeto principal do jogo](gaming/tutorial--defining-the-main-game-loop.md)
##### [Estrutura de renderização](gaming/tutorial--assembling-the-rendering-pipeline.md)
##### [Adicione a interface do usuário](gaming/tutorial--adding-a-user-interface.md)
...
#### [Efeitos de perspectiva 3D para interface do usuário XAML](graphics/3-d-perspective-effects.md)
## [Aplicativos Web hospedados](https://developer.microsoft.com/windows/bridges/hosted-web-apps)
## [Tarefas de Inicialização, retomada e de segundo plano](launch-resume/index.md)
...
#### [Estender seu aplicativo com serviços, extensões e pacotes](launch-resume/extend-your-app-with-services-extensions-packages.md)
...
## [Monetização, envolvimento e serviços da Loja](monetize/index.md)
...
#### [Esquemas de dados de produtos da Loja](monetize/data-schemas-for-store-products.md)
...
#### [Introdução](monetize/get-started-with-microsoft-advertising-libraries.md)
##### [Instalar o SDK do Microsoft Advertising](monetize/install-the-microsoft-advertising-libraries.md)
##### [Atualizar seu aplicativo para as bibliotecas mais recentes](monetize/update-your-app-to-the-latest-advertising-libraries.md)
...
##### [Tratamento de erros do AdControl](monetize/adcontrol-error-handling.md)
...
##### [Obter as instalações do aplicativo](monetize/get-app-installs.md)
...
##### [Obter dados de relatório de erros do seu aplicativo](monetize/get-error-reporting-data.md)
###### [Obter detalhes de um erro em seu aplicativo](monetize/get-details-for-an-error-in-your-app.md)
...
##### [Obter dados de relatório de erro para drivers do Windows 10](monetize/get-error-reporting-data-for-windows-10-drivers.md)
###### [Obter detalhes sobre um erro de driver do Windows 10](monetize/get-details-for-a-windows-10-driver-error.md)
###### [Baixe o arquivo CAB para um erro de driver do Windows 10](monetize/download-the-cab-file-for-a-windows-10-driver-error.md)
##### [Obter dados de relatório de erro para drivers do Windows 7 e Windows 8. x](monetize/get-error-reporting-data-for-windows-7-and-windows-8.x-drivers.md)
###### [Obtenha informações sobre o erro de driver do Windows 7 ou Windows 8. x](monetize/get-details-for-a-windows-7-or-windows-8.x-driver-error.md)
###### [Baixe o arquivo CAB para um erro de driver do Windows 7 ou Windows 8. x](monetize/download-the-cab-file-for-a-windows-7-or-windows-8.x-driver-error.md)
##### [Obter dados de relatórios de erros de hardware OEM](monetize/get-oem-hardware-error-reporting-data.md)
###### [Obter detalhes de um erro de hardware OEM](monetize/get-details-for-an-oem-hardware-error.md)
###### [Baixe o arquivo CAB de um erro de hardware OEM](monetize/download-the-cab-file-for-an-oem-hardware-error.md)
#### [Responder às opiniões](monetize/respond-to-reviews-using-windows-store-services.md)
...
###### [Exemplo de Java: envio do aplicativo com opções e trailers de jogos](monetize/java-code-examples-for-submissions-game-options-and-trailers.md)
...
##### [Reivindicar uma oferta direcionada](monetize/claim-a-targeted-offer.md)
...
#### [API de metadados de aplicativo para redes de publicidade](monetize/app-metadata-api-for-advertising-networks.md)
### [Enviar solicitações para a Loja](monetize/send-requests-to-the-store.md)
### [Criar um aplicativo de experiência de demonstração de revenda (RDX)](monetize/retail-demo-experience.md)
...
### [Arquiteturas de pacotes de aplicativo](packaging/device-architecture.md)
...
### [Pacotes opcionais e conjunto de criação relacionado](packaging/optional-packages.md)
...
### [Ponte de Desktop](porting/desktop-to-uwp-root.md)
...
##### [Teste para Windows 10 S](porting/desktop-to-uwp-test-windows-s.md)
...
### [Usando objetos do Windows Runtime em um ambiente de tempo de execução do Windows em um ambiente multithread](threading-async/using-windows-runtime-objects-in-a-multithreaded-environment.md)
...
### [Composição da interoperabilidade nativa](composition/composition-native-interop.md)
### [Iluminação de composição](composition/lighting.md)
...
### [Procedimento passo a passo: criando um componente básico do Windows Runtime em C++ e chamando-o em JavaScript ou C#](winrt-components/walkthrough-creating-a-basic-windows-runtime-component-in-cpp-and-calling-it-from-javascript-or-csharp.md)
...
## [Referência de API](https://msdn.microsoft.com/library/windows/apps/bg124285.aspx)
...
#### [Configurar o agendamento de lançamento preciso](publish/configure-precise-release-scheduling.md)
