...
### [Introdução ao design da interface do usuário de aplicativos](layout/design-and-ui-intro.md)
...
#### [Imprimir de seu aplicativo](devices-sensors/print-from-your-app.md)
...
### [Tratar a vinculação de aplicativos Web com manipuladores de URI de aplicativos](launch-resume/web-to-app-linking.md)
...
##### [Obter classificações de aplicativos](monetize/get-app-ratings.md)
...
##### [Obter dados de aplicativo](monetize/get-app-data.md)
###### [Obter todos os aplicativos](monetize/get-all-apps.md)
...
### [Baixar e instalar atualizações de pacote para seu aplicativo](packaging/self-install-package-updates.md)
