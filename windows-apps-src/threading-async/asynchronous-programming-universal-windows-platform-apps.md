...
Muitos recursos UWP, como o [ **MediaCapture** ](https://msdn.microsoft.com/library/windows/apps/BR241124) APIs e [ **StorageFile** ](https://msdn.microsoft.com/library/windows/apps/BR227171) APIs, são expostos como APIs assíncronas. Por convenção, os nomes das APIs assíncronas terminam com "Async" para indicar que a parte de sua execução é provável que ocorra depois que o controle tem retornado ao chamador.
...
* [Cenários de exemplo de recursos de Reversi: código assíncrono](https://msdn.microsoft.com/library/windows/apps/xaml/jj712233.aspx#async)
