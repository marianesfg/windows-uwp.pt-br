...
#### [Usar OpenCV com MediaFrameReader](../audio-video-camera/process-audio-frames-with-mediaframereader.md)
...
### [Tutorial: Criar associações de dados](../data-binding/xaml-basics-data-binding.md)
...
###### [Obter aquisições de jogo Xbox One](../monetize/get-xbox-one-game-acquisitions.md)
...
### [Introdução ao C++/WinRT](../cpp-and-winrt-apis/intro-to-using-cpp-with-winrt.md)
### [Introdução ao C++/WinRT](../cpp-and-winrt-apis/get-started.md)
### [Perguntas frequentes](../cpp-and-winrt-apis/faq.md)
### [Solução de problemas](../cpp-and-winrt-apis/troubleshooting.md)
### [Aplicativos de exemplo de C++/WinRT do Editor de Fotos](../cpp-and-winrt-apis/photo-editor-sample.md)
### [Manipulação de cadeia de caracteres](../cpp-and-winrt-apis/strings.md)
### [Tipos de dados C++ padrão e C++/WinRT](../cpp-and-winrt-apis/std-cpp-data-types.md)
### [Valores de conversão de boxing e unboxing valores para IInspectable](../cpp-and-winrt-apis/boxing.md)
### [Consumir APIs com C++/WinRT](../cpp-and-winrt-apis/consume-apis.md)
### [Criar APIs com C++/WinRT](../cpp-and-winrt-apis/author-apis.md)
### [Processamento de erros com C++/WinRT](../cpp-and-winrt-apis/error-handling.md)
### [Manejar eventos usando delegados](../cpp-and-winrt-apis/handle-events.md)
### [Criar eventos](../cpp-and-winrt-apis/author-events.md)
### [Coleções com C++/WinRT](../cpp-and-winrt-apis/collections.md)
### [Simultaneidade e operações assíncronas](../cpp-and-winrt-apis/concurrency.md)
### [Controles XAML; associar a uma propriedade C++/WinRT](../cpp-and-winrt-apis/binding-property.md)
### [Controles de itens XAML; associar a uma coleção C++/WinRT](../cpp-and-winrt-apis/binding-collection.md)
### [Controles personalizados (modelos) XAML com C++/WinRT](../cpp-and-winrt-apis/xaml-cust-ctrl.md)
### [Consumir componentes COM com C++/WinRT](../cpp-and-winrt-apis/consume-com.md)
### [Criar componentes COM com C++/WinRT](../cpp-and-winrt-apis/author-coclasses.md)
### [Interoperabilidade entre C++/WinRT e C++/CX](../cpp-and-winrt-apis/interop-winrt-cx.md)
### [Mudar do C++/CX para C++/WinRT](../cpp-and-winrt-apis/move-to-winrt-from-cx.md)
### [Interoperabilidade entre C++/WinRT e ABI](../cpp-and-winrt-apis/interop-winrt-abi.md)
### [Mudar do WRL para C++/WinRT](../cpp-and-winrt-apis/move-to-winrt-from-wrl.md)
### [Referências fracas](../cpp-and-winrt-apis/weak-references.md)
...
### [Controles UWP em aplicativos WPF e Windows Forms](../xaml-platform/xaml-host-controls.md)
