...
Lvalue (um tipo de glvalue) tem identidade, mas não móvel. Estes são os valores de leitura-gravação normalmente que você passa ao redor por referência ou referência const ou pelo valor se copiar é barata. Lvalue não pode ser vinculado a uma referência de rvalue.
