...
Você não pode mover lvalue. Mas há *é* um tipo de glvalue (o conjunto de coisas com identidade) que você pode mover&mdash;se você souber que você estiver fazendo (incluindo tenha cuidado para não acessá-lo após a mudança)&mdash;que é o xvalue. Nós vai revisitar essa ideia mais uma vez abaixo, quando vemos a imagem completa de categorias de valor.
