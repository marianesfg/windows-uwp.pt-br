...
| [Novidades no C++ c++ WinRT](news.md) | Alterações em C++ e notícias c++ WinRT. |
...
| [Criar componentes COM com C++/WinRT](author-coclasses.md) | C++ c++ WinRT pode ajudá-lo a criar componentes COM clássicos, assim como ele ajuda você a criar classes de tempo de execução do Windows. |
...
| [Referências fracas e fortes no C++ c++ WinRT](weak-references.md) | O tempo de execução do Windows é um sistema de contagem de referência; e, em um sistema desse tipo, é importante saber sobre o significado do e distinção entre, referências fracas e fortes. |
