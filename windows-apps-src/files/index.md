...
description: "Aprenda como ler e gravar configurações do app, seletores de pastas e arquivos e sobre locais especiais de área restrita, como a biblioteca de vídeo/música."
ms.author: lahugh
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
