...
Você não precisa fazer isso para uma biblioteca de classes (Universal Windows). Se estiver em dúvida, você pode usar [MakePri.exe](makepri-exe-command-options.md) para despejar o seu componente ou o arquivo PRI da biblioteca. Cada recurso `uri` é mostrado no arquivo despejado.
...
* [Como carregar recursos de cadeia de caracteres](https://msdn.microsoft.com/library/windows/apps/xaml/hh965323)