...
* * Nota sobre formatos de arquivo: * * o BC6H e BC7 formatos de compactação de textura usam o formato de arquivo DDS para armazenar os dados de textura compactado. Para obter mais informações, consulte o [Guia de programação para DDS](https://msdn.microsoft.com/library/windows/desktop/bb943991) para obter detalhes.
