...
keywords: "Compactação de bloco de textura"
author: PeterTurcan
ms.author: pettur
ms.date: 02/08/2017
ms.topic: article
...
O suporte para Compactação de Bloco (BC) para texturas foi estendido no Direct3D 11 para incluir os algoritmos BC6H e BC7. O BC6H dá suporte para dados de origem de cor de alto alcance dinâmico, e o BC7 fornece compactação de qualidade acima da média com menos artefatos para dados de origem RGB padrão.
...
**Observação sobre formatos de arquivo: ** Os formatos de compactação de textura a BC6H e BC7 usam o formato de arquivo DDS para armazenar dados de textura compactados. Para obter mais informações, consulte o [Guia de programação para DDS](https://msdn.microsoft.com/library/windows/desktop/bb943991) para obter detalhes.
