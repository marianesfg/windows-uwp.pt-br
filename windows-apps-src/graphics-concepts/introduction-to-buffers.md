...
Um recurso de buffer é uma coleção de dados completamente tipados, agrupados em elementos. Buffers armazenam dados, como as coordenadas de textura em um *buffer de vértice*, indexa em um *buffer de índice*, dados de constantes de sombreador em um *buffer constante*, vetores de posição, vetores normais ou estado do dispositivo.
