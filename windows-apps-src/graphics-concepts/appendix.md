...
<tbody>
<tr class="odd">
<td align="left"><p>[Regras de ponto flutuante](floating-point-rules.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Conversão de tipo de dados](data-type-conversion.md)</p></td>
<td align="left"><p>As seções a seguir descrevem como o Direct3D manipula as conversões entre os tipos de dados.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[Regras de rasterização](rasterization-rules.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Compactação de bloco de textura](texture-block-compression.md)</p></td>
