...
<tbody>
<tr class="odd">
<td align="left"><p>[Texturas opacas e alfa de 1 bit](opaque-and-1-bit-alpha-textures.md)</p></td>
<td align="left"><p>O formato de textura BC1 destina-se a texturas que são opacas ou que têm uma única cor transparente.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Texturas com canais alfa](textures-with-alpha-channels.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Compactação de bloco](block-compression.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Formatos de textura compactada](compressed-texture-formats.md)</p></td>
