...
keywords: "Estágio de fusão de saída (OM)"
author: PeterTurcan
ms.author: pettur
ms.date: 02/08/2017
ms.topic: article
...
<tbody>
<tr class="odd">
<td align="left"><p>[Configuração da funcionalidade de estêncil de profundidade](configuring-depth-stencil-functionality.md)</p></td>
