...
keywords: "Transformação da projeção"
author: PeterTurcan
ms.author: pettur
ms.date: 02/08/2017
ms.topic: article
...
A *transformação da projeção* controla o interior da câmera, como a escolha de uma lente para uma câmera. Esse é o mais complicado dos três tipos de transformação.
