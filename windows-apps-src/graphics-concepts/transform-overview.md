...
No C++, o Direct3D declara matrizes como uma matriz bidimensional, usando uma estrutura de matriz. O exemplo a seguir mostra como inicializar uma estrutura [**D3DMATRIX**](https://docs.microsoft.com/windows/desktop/direct3d9/d3dmatrix) para atuar como uma matriz de dimensionamento uniforme (fator de escala "s").
