...
keywords: "Mapeamentos estão em um pool de blocos"
...
<tbody>
<tr class="odd">
<td align="left"><p>[Criação de pool de blocos](tile-pool-creation.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Redimensionamento de pool de blocos](tile-pool-resizing.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Controle de risco versus recursos de pool de blocos](hazard-tracking-versus-tile-pool-resources.md)</p></td>
