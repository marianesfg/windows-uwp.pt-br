...
keywords: Texturas com canais alfa
...
Há duas maneiras de codificar mapas de texturas que exibem uma transparência mais complexa. Em cada caso, um bloco que descreve a transparência precede o bloco de 64 bits já descrito. A transparência é representada como um bitmap 4x4 com 4 bits por pixel (codificação explícita) ou com menos bits e interpolação linear, semelhante ao que é usado para a codificação de cores.
