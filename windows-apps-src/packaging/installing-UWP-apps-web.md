...
> [!NOTE]
> Versão do Instalador de Aplicativo superior a 1.0.12271.0 é necessária para oferecer suporte aos novos recursos.
...
Aqui está uma rápida comparação de versão de atualização do Windows 10 Fall Creator do Instalador de Aplicativo e a versão anterior do Instalador de Aplicativo:
