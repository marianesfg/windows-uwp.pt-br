...
O arquivo do Instalador de Aplicativo também pode especificar a configuração de atualização para que os conjuntos relacionados possam ser atualizados automaticamente quando um arquivo mais recente do Instalador de Aplicativo for publicado. **<UpdateSettings>** é um elemento opcional. 
``` xml
<?xml version="1.0" encoding="utf-8"?>
<AppInstaller
    xmlns="http://schemas.microsoft.com/appx/appinstaller/2017"
...
> [!NOTE]
> 
> O tipo de arquivo do Instalador de Aplicativo é uma novidade no Windows 10 Fall Creators Update. Não há nenhum suporte para implantação de aplicativos UWP usando um arquivo do Instalador de Aplicativo em versões anteriores do Windows 10. 