...
-   **Os usuários examinam, eles não leem:** porque a ajuda que um usuário está procurando pode estar na mesma página que outros tópicos da ajuda, verifique se eles podem perceber qual tópico eles precisam focalizar.
...
-   **Focalize um problema:** espaço é ainda mais restrito em um pop-up que em uma página da ajuda. Os pop-ups da ajuda precisam fazer referência a uma tarefa específica para serem eficazes.
...
-   **Não use muitos recursos:** a ajuda não deve demorar ou ter carregamento lento. O uso de arquivos de áudio ou vídeos ou imagens de alta resolução em pop-ups é provavelmente mais frustrante do que útil para o usuário.
...
-   **Não ensine noções básicas:** pressuponha que o usuário já conhece os conceitos básicos de como usar o item que está sendo descrito. Esclarecer ou oferecer informações adicionais é útil. Informar o que o usuário já sabe não é.
