...
No exemplo de aplicativo 4, qualquer dispositivo que execute o Windows 10 pode obter o aplicativo, mas não estará disponível para clientes com uma versão anterior do sistema operacional. Como o pacote UWP é direcionado à família de dispositivos universal, ele estará disponível para qualquer dispositivo Windows 10.
