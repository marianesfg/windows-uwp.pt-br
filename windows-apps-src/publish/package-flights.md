...
ms.locfileid: "8468482"
---
# <a name="package-flights"></a>Pacotes de pré-lançamento

Você pode usar pacotes de pré-lançamento para distribuir pacotes específicos para um grupo de testadores limitado. Os pacotes que você já tiver publicado na Store serão usados para seus clientes, portanto, sua experiência não será afetada.
...
Seu envio de versão completa é sempre classificado como o mais baixo (1). Ou seja, as pessoas que não estiverem em nenhum de seus grupos de versão de pré-lançamento podem receber apenas pacotes de seu envio de versão completa por meio da Loja. As pessoas em um grupo de versão de pré-lançamento sempre receberão pacotes do pacote classificado de pré-lançamento disponível para elas (mas nunca o envio de versão completa, já que ele tem a classificação mais baixa). Isso proporciona flexibilidade para determinar como distribuir seus pacotes para as pessoas que podem ser membros de mais de um de seus grupos de versão de pré-lançamento.
