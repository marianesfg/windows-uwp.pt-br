...
|--------------------------------------|------------------------------------|------------|
|**Relatório de percepções**: quando detectarmos uma anomalia (uma alteração significativa em seus dados de aquisições, de integridade ou de uso), mostraremos os detalhes nesse relatório.  | No menu de navegação esquerdo, expanda **Analisar** e então selecione **Percepções**. | Março de 2018 |
...
|**Detalhes rápidos sobre anomalias**: veja rapidamente as alterações significativas em suas aquisições, uso e dados de integridade. | Nos relatórios de **Aquisições**, **Uso** e **Integridade**, exibiremos um marcador em círculo no final da semana se detectarmos anomalias (aumentos ou diminuições significativas) em comparação com a semana anterior. Passe o mouse sobre o círculo para ver detalhes sobre o que mudou. | Janeiro de 2018 |
...
|**Dados de integridade quase em tempo real**: o relatório de **Integridade** agora mostra dados de falhas, travamentos, falhas de memória e exceções de JavaScript em tempo quase real ao usar a opção de filtro de página **72H**.  | Relatório de integridade de um aplicativo, escolha a opção **72H** na parte superior da página. Observe que você poderá ver uma discrepância nos dados em um período de 72 horas ao comparar os filtros **72H** e **30D**. Isso é um problema conhecido que estamos trabalhando para resolver.  | Setembro de 2017|
