...
-   **Use listas e parágrafos curtos.** Clientes potenciais podem dar apenas uma rápida olhada na descrição do seu aplicativo. Se o conteúdo for dividido usando parágrafos curtos e listas, a avaliação fica mais fácil.
    > **Observação**  Adicionar uma lista de [recursos do aplicativo](create-app-store-listings.md#app-features) também pode ajudar a mostrar rapidamente o que ele faz. A lista aparece logo abaixo da descrição do aplicativo.
