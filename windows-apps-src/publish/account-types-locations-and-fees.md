...
Você deve ter uma conta empresarial, especificamente para publicar aplicativos que usam as três funcionalidades a seguir:
...
Para contas empresariais, usamos a Symantec ou a Dun & Bradstreet para verificar que você está autorizado a criar uma conta para a empresa que está representando. Este processo pode demorar de alguns dias a algumas semanas e geralmente inclui uma chamada telefônica para sua empresa (especifique informações de contato atualizadas ao preencher os formulários de registro). Não é possível enviar aplicativos de uma conta corporativa até que eles tenham sido verificados, mas enquanto está esperando, você pode [reservar um nome de aplicativo](https://msdn.microsoft.com/library/windows/apps/JJ657967), acessar seu painel do Centro de Desenvolvimento do Windows, e continuar compilando e testando seu aplicativo.

## Mercados de conta de desenvolvedor e de envio de aplicativos
