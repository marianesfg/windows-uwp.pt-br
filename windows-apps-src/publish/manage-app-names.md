...
Observe que seu app precisa ter pelo menos um nome reservado. Para remover completamente um app do painel (e liberar todos os nomes reservados para esse app), você poderá clicar em **Excluir este app** da página **Visão geral**. Se você tiver um envio para o app em andamento, precisará excluir esse envio primeiro (e, se você já tiver publicado o app na Loja, não poderá excluí-lo do painel).

## <a name="rename-an-app-that-has-already-been-published"></a>Renomear um app que já tenha sido publicado

Se o seu aplicativo já está na Windows Store e você deseja renomeá-lo, é possível fazer isso reservando um novo nome para ele (seguindo as etapas descritas acima) e, em seguida, criando um novo envio para o aplicativo. Observe que você precisará atualizar seu pacote para incluir o novo nome para a Loja exibir o aplicativo com o novo nome. Certifique-se de usar o novo nome no elemento [**Package/Properties/DisplayName**](https://msdn.microsoft.com/en-us/library/windows/apps/dn934748.aspx) no manifesto do aplicativo e atualize elementos gráficos ou texto que inclua o nome do aplicativo. Você também vai querer revisar a descrição do aplicativo e alterar o nome caso ele seja mencionado lá.
