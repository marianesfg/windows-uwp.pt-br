...
1.  Na página **Usuários**, selecione **Adicionar usuários**. 
...
5.  Clique em **Salvar**.
Se sua conta tem [permissões de administrador global](http://go.microsoft.com/fwlink/p/?LinkId=746654), você verá algumas outras maneiras de adicionar usuários.

### <a name="additional-methods-for-adding-users"></a>Outros métodos para adicionar usuários

Se você estiver conectado com uma conta de gerenciador que também tem permissões de [administrador global](http://go.microsoft.com/fwlink/?LinkId=746654) para o locatário do Azure AD em que você está trabalhando, terá outras opções para adicionar usuários à sua conta do Centro de Desenvolvimento. Selecione uma das seguintes opções:

-   **Adicionar usuários existentes**: escolha os usuários que já existem no diretório da sua organização e conceda a eles acesso à sua conta do Centro de Desenvolvimento, conforme descrito acima.
-   **Criar novos usuários**: crie novas contas de usuários para adicionar ao diretório e à conta do Centro de Desenvolvimento da sua organização.
...
1.  Na página **Usuários**, clique no nome da conta de usuário que você deseja editar.
...
1.  Na página **Usuários**, clique em **Adicionar grupos**.
...
### <a name="add-azure-ad-applications-from-your-organizations-directory"></a>Adicionar aplicativos Azure AD do diretório da sua organização

1.  Na página **Usuários**, selecione **Adicionar aplicativos Azure AD**.
...
1.  Na página **Usuários**, selecione **Adicionar aplicativos Azure AD**.
2.  Na página seguinte, clique em **Novo aplicativo Azure AD**.
...
1.  Na página **Usuários**, clique no nome do aplicativo Azure AD.
    > [!TIP]
...
1.  Na página **Usuários**, clique no nome da conta de usuário, grupo ou aplicativo Azure AD que deseja editar.
...
Na página **Usuários**, clique no link mostrado em **Última atividade** do usuário cujo histórico de navegação você deseja analisar. Você poderá exibir os URLs de todas as páginas que o usuário visitou nos últimos 30 dias.

<span id="remove" />
## <a name="remove-users-groups-and-azure-ad-applications"></a>Remover usuários, grupos e aplicativos Azure AD

Para remover um usuário, grupo ou aplicativo Azure AD da sua conta do Centro de Desenvolvimento, clique no link **Remover** que é exibido ao lado do nome na página **Usuários**. Depois de confirmar que deseja removê-la, esse usuário, grupo ou aplicativo do Azure AD não poderá mais acessar sua conta do Centro de Desenvolvimento (a menos que você a adicione novamente mais tarde).
