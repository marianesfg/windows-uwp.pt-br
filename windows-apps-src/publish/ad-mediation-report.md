...
Esse relatório mostra dados de controle de anúncios para aplicativos Windows 8.x ou Windows Phone 8.x que usam um **AdMediatorControl** do [SDK do Microsoft Advertising para Windows e Windows Phone 8.x](http://aka.ms/store-8-sdk) para fazer o controle de anúncios em faixa em várias redes de publicidade. Nesses aplicativos, este relatório permite que você veja sua taxa de preenchimento efetiva e as respectivas taxas de preenchimento das redes de publicidade que você está usando. Ele também mostra as taxas de adoção de cada uma das suas configurações de controle e dá visibilidade aos erros relatados por redes de publicidade e pelo mediador. Você pode exibir esses dados no painel ou [baixar o relatório](download-analytic-reports.md) para exibir offline.

> [!NOTE]
> O relatório **Mediação de anúncios** está disponível somente se você estiver usando um **AdMediatorControl** no Windows 8. x ou no aplicativo do Windows Phone 8. x. Para obter mais informações, consulte [este artigo](https://msdn.microsoft.com/library/windows/apps/xaml/dn864359). Para um aplicativo UWP que usa o [controle de anúncios](monetize-with-ads.md#mediation) em um **AdControl** ou **InterstitialAd**, use o [Relatório de desempenho de anúncios](advertising-performance-report.md) para analisar os dados de desempenho das redes de publicidade.
