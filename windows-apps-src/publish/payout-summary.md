...
## Receita por aplicativo e ajustes
...
## Baixando transações de pagamento
...
| Taxa da Loja               | O percentual dos Recebimentos Líquidos retidos pela Microsoft como taxa pela disponibilização do aplicativo ou do produto no aplicativo na Loja.                |
| Receita do aplicativo            | Recebimentos líquidos menos a taxa da Loja                                                                                                         |
| Impostos retidos          | Valor do imposto de renda retido                                                                                                            |
| Pagamento                 | Receita do aplicativo menos retenção de imposto de renda aplicável (valor mostrado na moeda da transação)                                           |
...
| Encargos                 | Mostra uma divisão de todos os detalhes de cobrança agregados na coluna Valor da Transação. (Somente incluído para o Azure Marketplace.)          |
