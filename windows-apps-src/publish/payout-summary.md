---
author: jnHs
Description: "O Resumo de pagamentos mostra detalhes do dinheiro que você ganhou com os seus apps e complementos. Ele também permite saber quando você receberá os pagamentos e quanto você será pago."
...
O **Resumo de pagamentos** mostra detalhes do dinheiro que você ganhou com os seus apps e complementos. Ele também permite saber quando você receberá os pagamentos e quanto você será pago.

Se você usa o Microsoft Advertising para ganhar dinheiro desde 1º de abril de 2016, também verá informações de pagamento sobre receita de publicidade no **Resumo de pagamento**. Mostraremos o app no qual essas receitas foram ganhas ou "não mapeado" para unidades utilizadas em vários apps ou que não podem ser mapeadas para um app específico. 
...
## <a name="proceeds-by-app-and-adjustments"></a>Receita por app e ajustes


Esta seção divide as informações do resumo para permitir que você veja detalhes específicos por app. Se você tiver recebido dinheiro por meio da Microsoft Advertising, a quantidade total da receita de publicidade será mostrada aqui como um item de linha único.

Ao examinar esta seção, você poderá determinar quais apps geraram dinheiro que está atualmente nas categorias **Reservado** ou **Pagamento mais recente**. Você também poderá ver o valor total recebido por cada app. Caso seja necessário fazer [ajustes](#proceeds-by-app-and-adjustments) no saldo de sua conta, também é possível exibi-los aqui. (Os ajustes de receita do Microsoft Advertising não são mostrados aqui no momento.)
...
Abaixo na seção **Divisão de receitas**, você pode ver detalhes sobre quanto dinheiro foi ganho por mercado e por fonte de receita (por exemplo, Loja do Windows Phone, Windows Store 8, Windows Store, etc.) por app. Você também verá detalhes sobre quaisquer [ajustes](#proceeds-by-app-and-adjustments) feitos, inclusive a data, o valor e o motivo do ajuste.

As seções mencionadas acima mostram apenas informações sobre sua receita (e ajustes) de vendas do app. Se ganhar dinheiro com publicidade, você verá uma seção separada da Microsoft Advertising com detalhes sobre os pagamentos e as conversões de moeda.
...
| Taxa da Loja               | O percentual dos Recebimentos Líquidos retidos pela Microsoft como taxa pela disponibilização do app ou do complemento na Loja.                |
| Receita do app            | Recebimentos líquidos menos a taxa da Loja.                                                                                                         |
| Impostos retidos          | Valor do imposto de renda retido. (Não incluído no arquivo .csv **Reservado**.)                                                                                                           |
| Pagamento                 | Receita do app menos retenção de imposto de renda aplicável (valor mostrado na moeda da transação). (Não incluído no arquivo .csv **Reservado**.)                                           |
