...
Para exibir e criar grupos de clientes, expanda **envolver** no menu de navegação esquerdo do [Centro de desenvolvimento do Windows](https://partner.microsoft.com/dashboard), selecione os **grupos de clientes**.
