---
author: jnHs
Description: "O relatório de análise do Xbox no painel do Centro de Desenvolvimento do Windows mostra estatísticas sobre como os clientes estão participando com os recursos do Xbox em seu produto."
...
> [!IMPORTANT]
> Você só verá esse relatório se estiver publicando um jogo para Xbox ou um jogo que usa os serviços Xbox Live. Para fazer isso, você deve habilitar o [Programa de Criadores do Xbox Live](../xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md) ou pode percorrer o [processo de aprovação de conceito](../gaming/concept-approval.md). 
