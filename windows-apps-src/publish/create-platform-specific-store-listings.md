...
Os clientes no Windows 10 (incluindo o Xbox) sempre verão a [listagem da Store](create-app-store-listings.md)de padrão. Você não verá a opção de criar listagens da loja específicas de plataforma, a menos que você já publicou seu aplicativo com pacotes que dão suporte a uma ou mais versões do sistema operacional anteriores. 
