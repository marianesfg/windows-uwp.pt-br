...
> [!IMPORTANT]
> Na última (quarta) seção do número da versão é reservada para uso da Loja e deve ser deixada como 0 quando você compilar o pacote (embora a Loja possa alterar o valor nessa seção).
...
> [!NOTE]
> Se você também tiver pacotes do Windows 10, o número da versão dos pacotes do Windows 10 deve ser maior do que aqueles para pacotes do Windows 8, Windows 8.1 e/ou do Windows Phone 8.1 que você está publicando ou publicou. (Para obter mais informações, consulte [Adicionando pacotes para Windows 10 a um aplicativo publicado anteriormente](guidance-for-app-package-management.md#adding-packages-for-windows-10-to-a-previously-published-app)).
