...
A opção **Audiência particular** pode ser usada com os apps destinados a qualquer versão do sistema operacional, mas seus testadores devem executar o Windows 10, versão 1607 ou posterior (incluindo o Xbox One) e devem estar conectados com a conta da Microsoft associada ao endereço de email fornecido.
