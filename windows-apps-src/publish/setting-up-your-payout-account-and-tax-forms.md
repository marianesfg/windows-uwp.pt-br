...
Depois de ter [configurado sua conta de desenvolvedor](opening-a-developer-account.md), existem duas coisas que você precisa fazer antes de você pode vender aplicativos (complementos ou) em que o Microsoft Store:
...
Depois de ter [registrado para uma conta de desenvolvedor](opening-a-developer-account.md) e configurar sua [conta de pagamento](#payout-account), você pode criar seu *perfil de imposto* para o Microsoft Store concluindo as seguintes etapas:
