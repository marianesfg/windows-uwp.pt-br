---
Description: Para receber dinheiro de vendas de aplicativo em que a Microsoft Store, você precisa configurar sua conta de pagamento e preencher os formulários de imposto necessárias.
