...
> [!NOTE]
> Se uma unidade de anúncio não tiver nenhuma atividade nos últimos seis meses, podemos será rotule-o como **inativo**e eventualmente removê-lo do painel. Você pode usar filtros para mostrar apenas unidades publicitárias **Ativas** ou **Inativas**. Caso veja uma unidade publicitária que você acredita que esteja marcada incorretamente como **Inativa**, [contate o suporte](http://aka.ms/storesupport).
