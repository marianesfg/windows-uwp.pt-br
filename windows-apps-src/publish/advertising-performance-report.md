...
| Visualização | A porcentagem de impressões de anúncio que são visíveis no seu aplicativo. Para obter mais detalhes sobre como esse valor é calculado, consulte [otimizar a visualização da suas unidades da ad](../monetize/optimize-ad-unit-viewability.md). |
