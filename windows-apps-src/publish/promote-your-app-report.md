...
O relatório de **Campanha publicitária** no painel do Centro de Desenvolvimento do Windows permite que você veja o desempenho das campanhas de anúncios de promoção do aplicativo.

Para ver o relatório, expanda **Atrair** no menu de navegação esquerdo e selecione **Campanhas publicitárias** (ou, em um aplicativo, expanda **Monetização** e selecione **Promover seu aplicativo**). 
