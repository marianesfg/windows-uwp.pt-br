...
-   Adicione um número de telefone para informações de segurança da conta da Microsoft. Tente usar um número que não exige uma extensão e é acessível aos principais membros da equipe.
