...
<tr><td align="left">    <b>Controle de anúncios</b>                        </td><td align="left">  Pode exibir <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt149935.aspx">configurações de controle de anúncios</a> para todos os produtos na conta.    </td><td align="left">  Pode exibir e alterar <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt149935.aspx">configurações de controle de anúncios</a> para todos os produtos na conta.        </td></tr>
...
<tr><td align="left">    <b>Grupos de clientes</b>                     </td><td align="left">  Pode exibir <a href="create-customer-groups.md">grupos de clientes</a> (segmentos e grupos de versão de pré-lançamento) na seção <b>Clientes</b>.      </td><td align="left">  Pode criar, editar e exibir <a href="create-customer-groups.md">grupos de clientes</a> (segmentos e grupos de versão de pré-lançamento) na seção <b>Clientes</b>.       </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Aquisições</b>     </td><td>    Pode exibir os relatórios <a href="acquisitions-report.md">Aquisições</a> e <a href="add-on-acquisitions-report.md">Aquisições de complemento</a> do produto.        </td><td>    N/D    </td><td>    N/D (configurações do produto pai incluem relatórios de aquisição de complemento)        </td><td>    N/D                         </td></tr>
    ...
    <tr><td align="left">    <b>Análise do Xbox</b> </td><td>    Pode exibir o relatório de análise do Xbox para o produto. (Observação: este relatório ainda não está disponível.)    </td><td>    N/A   </td><td>    N/D       </td><td>    N/D          </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Reservas de nome</b>   </td><td>    Pode exibir a página <a href="manage-app-names.md">Gerenciar nomes de aplicativo</a> do produto.</td><td>    Pode exibir e editar a página <a href="manage-app-names.md">Gerenciar nomes de aplicativo</a> do produto, incluindo reservar nomes adicionais e excluir nomes reservados. </td><td>   <i> Pode exibir nomes reservados para o complemento.    </td><td>   </i> Pode exibir e editar nomes reservados para o complemento.          </td></tr>
    </tbody>
    </table>
