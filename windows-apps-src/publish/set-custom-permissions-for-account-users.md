...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Aquisições</b>     </td><td>    Pode exibir os relatórios <a href="acquisitions-report.md">Aquisições</a> e <a href="add-on-acquisitions-report.md">Aquisições de complemento</a> do produto.        </td><td>    N/D    </td><td>    N/d (configurações de produto pai incluem o **aquisições de complemento** relatório)        </td><td>    N/D                         </td></tr>
    ...
    <tr><td align="left">    <b>Integridade</b> </td><td>    Pode exibir o <a href="health-report.md">Relatório de integridade</a> do produto.    </td><td>    N/D     </td><td>    N/D     </td><td>    N/D         </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Listagens de Store</b>  </td><td>    Pode exibir a(s) <a href="create-app-store-listings.md">página(s) Listagem da Loja</a> para envios de produto.  </td><td>    Pode exibir e editar a(s) <a href="create-app-store-listings.md">página(s) Listagem da Loja</a> para envios de produto, e pode adicionar novas listagens da Loja para vários idiomas.     </td><td>    Pode exibir a(s) <a href="create-add-on-store-listings.md">página(s) Listagem da Loja</a> para envios de complemento.            </td><td>    Pode exibir e editar a(s) <a href="create-add-on-store-listings.md">página(s) Listagem da Loja</a> para envios de complemento, e pode adicionar novas listagens da Loja para vários idiomas.                 </td></tr>
