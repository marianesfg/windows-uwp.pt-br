---
Description: Definir funções ou permissões personalizadas para usuários de conta.
...
Quando você [adicionar usuários à sua conta no Partner Center](add-users-groups-and-azure-ad-applications.md), você precisará especificar a qual eles têm dentro da conta de acesso. Você pode fazer isso ao atribuir [funções padrão](#roles), que se aplicam à conta inteira, ou [personalizar as permissões deles](#custom) para fornecer o nível apropriado de acesso. Algumas das permissões personalizadas se aplicam à conta inteira, e algumas podem ser limitadas a um ou mais produtos específicos (ou concedidas a todos os produtos, se desejar).
...
-   Os usuários (incluindo grupos e aplicativos do Azure AD) poderão acessar toda a conta do Centro de parceiros com as permissões associadas às suas funções atribuídas, a menos que você [personalizar permissões](#custom) e atribua [ permissões de nível de produto](#product-level-permissions) para que elas só funcionam com aplicativos específicos e/ou complementos.
...
Por padrão, um conjunto de funções padrão é apresentado para sua escolha quando você adiciona um usuário, grupo ou aplicativo do Azure AD para sua conta no Partner Center. Cada função tem um conjunto específico de permissões para executar determinadas funções na conta. 
...
| Função                 | Descrição              |
|----------------------|--------------------------|
| Manager              | Tem acesso completo à conta, exceto para alterar configurações de imposto e pagamento. Isso inclui o gerenciamento de usuários no Partner Center, mas observe que a capacidade de criar e excluir usuários no locatário do Azure AD é dependente de permissão da conta do Azure AD. Ou seja, se um usuário é atribuído a função de gerente, mas não tem permissões de administrador global da organização do Azure AD, eles não poderão criar novos usuários ou excluir usuários do diretório (embora eles podem alterar uma função de usuário Partner Center). <p> Observe que, se a conta no Partner Center estiver associada a mais de um locatário do AD do Azure, um gerente não consegue ver detalhes completos para um usuário (incluindo nome, sobrenome, email de recuperação de senha, e se elas são de administrador global do Azure AD), a menos que eles são conectado ao mesmo locatário que esse usuário com uma conta que tenha permissões de administrador global para esse locatário. No entanto, eles podem adicionar e remover usuários em qualquer locatário que está associado com a conta no Partner Center. |
| Desenvolvedor            | Pode carregar pacotes e enviar aplicativos e complementos, além de exibir o [Relatório de uso](usage-report.md) para obter detalhes de telemetria. Pode acessar [experiências entre dispositivos](https://go.microsoft.com/fwlink/?linkid=874042) funcionalidade. Não pode exibir informações financeiras ou configurações da conta.   |
...
<tr><td align="left">    <b>Relatório de desempenho no nível da conta ad</b> </td><td align="left">  Pode exibir o <a href="advertising-performance-report.md">Relatório de desempenho de anúncios</a> no nível da conta.      </td><td align="left">  N/D   </td></tr>
...
<tr><td align="left">    <b>Mediação do AD</b>                        </td><td align="left">  Pode exibir as configurações de mediação do ad para todos os produtos na conta.    </td><td align="left">  Pode exibir e alterar as configurações de mediação do ad para todos os produtos na conta.        </td></tr>
<tr><td align="left">    <b>Relatórios de mediação do AD</b>                </td><td align="left">  Pode exibir o <a href="ad-mediation-report.md">Relatório de controle de anúncios</a> para todos os produtos na conta.    </td><td align="left">  N/D    </td></tr>
<tr><td align="left">    <b>Relatórios de desempenho do AD</b>              </td><td align="left">  Pode exibir <a href="advertising-performance-report.md">Relatórios de desempenho de anúncios</a> para todos os produtos na conta.       </td><td align="left">  N/D         </td></tr>
<tr><td align="left">    <b>Unidades de anúncios</b>                            </td><td align="left">  Pode exibir as <a href="in-app-ads.md">unidades de anúncio</a> que foram criadas para a conta.    </td><td align="left">  Pode criar, gerenciar e exibir <a href="in-app-ads.md">unidades de anúncio</a> para a conta.             </td></tr>
<tr><td align="left">    <b>Afiliado anúncios</b>                       </td><td align="left">  Pode exibir o uso de <a href="about-affiliate-ads.md">anúncios de afiliadas</a> em todos os produtos na conta.    </td><td align="left">  Pode gerenciar e exibir o uso de <a href="about-affiliate-ads.md">anúncios de afiliadas</a> para todos os produtos na conta.                </td></tr>
<tr><td align="left">    <b>Relatórios de desempenho afiliadas</b>      </td><td align="left">  Pode exibir o <a href="affiliates-performance-report.md">Relatório de desempenho de afiliadas</a> para todos os produtos na conta.   </td><td align="left">  N/D   </td></tr>
<tr><td align="left">    <b>Relatórios de anúncios de instalação do aplicativo</b>             </td><td align="left">  Pode exibir o <a href="promote-your-app-report.md">Relatório de campanha publicitária</a>.           </td><td align="left">  N/D   </td></tr>
...
<tr><td align="left">    <b>Dispositivos do Xbox</b>                        </td><td align="left">  Pode exibir os consoles de desenvolvimento do Xbox habilitados para a conta na seção <b>Configurações da conta</b>.       </td><td align="left">  Pode adicionar, remover e exibir os consoles de desenvolvimento do Xbox habilitados para a conta na seção <b>Configurações da conta</b>.     </td></tr>
    </tbody>
    </table>

\* Permissões são marcados com um acesso de concessão de asterisco (*) para recursos que não estão disponíveis para todas as contas. Se sua conta não tiver sido habilitada para esses recursos, suas seleções para essas permissões não terão nenhum efeito.   
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Aquisições</b> (incluindo dados quase em tempo Real) </td><td>    Pode exibir os relatórios <a href="acquisitions-report.md">Aquisições</a> e <a href="add-on-acquisitions-report.md">Aquisições de complemento</a> do produto.        </td><td>    N/D    </td><td>    N/d (configurações de produto pai incluem o **aquisições de complemento** relatório)        </td><td>    N/D                         </td></tr>
    ...
    <tr><td align="left">    <b>Comentários do cliente</b>    </td><td>    Pode exibir os relatórios <a href="reviews-report.md">análises</a> e <a href="feedback-report.md">Comentários</a> do produto.       </td><td>    N/D (para responder a comentários ou críticas, a permissão <b>Contato com cliente</b> deve ser concedida)   </td><td>    N/D     </td><td>    N/D         </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Entre em contato com o cliente</b>  </td><td>    Pode exibir <a href="respond-to-customer-feedback.md">respostas aos comentários dos clientes</a> e <a href="respond-to-customer-reviews.md">respostas às críticas dos clientes</a>, desde que a permissão de <b>Comentários dos clientes</b> também tenha sido concedida. Também pode exibir <a href="send-push-notifications-to-your-apps-customers.md">notificações direcionadas</a> que foram criadas para o produto.    </td><td>    Pode <a href="respond-to-customer-feedback.md">responder aos comentários dos clientes</a> e <a href="respond-to-customer-reviews.md">responder às revisões do cliente</a>, desde que o <b>comentários dos clientes</b> permissão foi concedida também. Também pode <a href="send-push-notifications-to-your-apps-customers.md">criar e enviar notificações direcionadas</a> para o produto.                   </td><td>    N/D         </td><td>    N/D                          </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Instalação do produto</b>  </td><td>    Pode exibir a página de instalação do produto de produtos.     </td><td>    Pode exibir e editar a página de instalação do produto de produtos. </td><td>    Pode exibir a página de instalação do produto de complementos.   </td><td>    Pode exibir e editar os complementos de página de instalação do produto.          </td></tr>
    <tr><td align="left">    <b>Preços e disponibilidade</b>  </td><td>    Pode exibir o <a href="set-app-pricing-and-availability.md">preços e disponibilidade</a> página de produtos.     </td><td>    Pode exibir e editar os <a href="set-app-pricing-and-availability.md">preços e disponibilidade</a> página de produtos. </td><td>    Pode exibir o <a href="set-add-on-pricing-and-availability.md">preços e disponibilidade</a> página de complementos.   </td><td>    Pode exibir e editar os <a href="set-add-on-pricing-and-availability.md">preços e disponibilidade</a> página de complementos.          </td></tr>
    <tr><td align="left">    <b>Propriedades</b>   </td><td>    Pode exibir o <a href="enter-app-properties.md">propriedades</a> página de produtos.      </td><td>    Pode exibir e editar os <a href="enter-app-properties.md">propriedades</a> página de produtos.       </td><td>    Pode exibir o <a href="enter-add-on-properties.md">propriedades</a> página de complementos.     </td><td>    Pode exibir e editar os <a href="enter-add-on-properties.md">propriedades</a> página de complementos.               </td></tr>
    <tr><td align="left">    <b>Classificação etária</b>    </td><td>    Pode exibir o <a href="age-ratings.md">idade classificações</a> página de produtos.       </td><td>    Pode exibir e editar os <a href="age-ratings.md">idade classificações</a> página de produtos.    </td><td>    Pode exibir a página de classificação de idade de complementos.          </td><td>     Pode exibir e editar a página de classificação de idade de complementos.       </td></tr>
    <tr><td align="left">    <b>Pacotes</b>        </td><td>    Pode exibir o <a href="upload-app-packages.md">pacotes</a> página de produtos.  </td><td>    Pode exibir e editar os <a href="upload-app-packages.md">pacotes</a> página de produtos, incluindo o carregamento de pacotes.     </td><td>   Pode exibir o <a href="upload-app-packages.md">pacotes</a> página de complementos (se aplicável).   </td><td>     Pode exibir e editar <a href="upload-app-packages.md">pacotes</a> página de complementos (se aplicável).             </td></tr>
    <tr><td align="left">    <b>Listagens de Store</b>  </td><td>    Pode exibir o <a href="create-app-store-listings.md">Store (s) de listagem</a> de produtos.  </td><td>    Pode exibir e editar os <a href="create-app-store-listings.md">Store (s) de listagem</a> de produtos e pode adicionar novas listagens de Store para diferentes idiomas.     </td><td>    Pode exibir o <a href="create-add-on-store-listings.md">Store (s) de listagem</a> de complementos.            </td><td>    Pode exibir e editar os <a href="create-add-on-store-listings.md">Store (s) de listagem</a> de complementos e pode adicionar listagens Store para diferentes idiomas.                 </td></tr>
    <tr><td align="left">    <b>Envio de Store</b>     </td><td>    Não é concedido acesso se essa permissão for definida como somente leitura.           </td><td>    Pode enviar o produto para a Loja e exibir relatórios de certificação. Inclui envios novos e atualizados. </td><td>Não é concedido acesso se essa permissão for definida como somente leitura.     </td><td>    Pode enviar o complemento para a Loja e exibir relatórios de certificação. Inclui envios novos e atualizados.</td></tr>
    <tr><td align="left">    <b>Nova criação de envio</b>       </td><td>    Não é concedido acesso se essa permissão for definida como somente leitura.        </td><td>    Pode criar novos <a href="app-submissions.md">envios</a> para o produto.  </td><td>    Não é concedido acesso se essa permissão for definida como somente leitura.   </td><td>    Pode criar novos <a href="add-on-submissions.md">envios</a> para o complemento.        </td></tr>
    ...
    <tr><td align="left">    <b>Solicitação de disco</b>   </td><td>    Pode exibir a página de solicitação do disco. </td><td>    Pode criar solicitações de disco. </td><td>   N/D    </td><td>   N/D          </td></tr>
    <tr><td align="left">    <b>Royalties de disco </b>   </td><td>    Pode exibir a página de royalties do disco.</td><td>    Pode criar royalties de disco. </td><td>   N/D    </td><td>   N/D          </td></tr>
    </tbody>
    </table>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Terceiras partes confiáveis</b>&nbsp;*</td><td>    Pode exibir a página de partes de terceira parte confiável de uma conta.   </td><td>    Exiba e edite a página de partes de terceira parte confiável de uma conta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Serviços de parceiros</b>&nbsp;*</td><td>    Pode exibir a página de serviços da Web de uma conta.  </td><td>    Pode exibir e editar a página de serviços da Web de uma conta.      </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Contas de teste do Xbox</b>&nbsp;*</td><td>    Pode exibir a página de contas de teste do Xbox de uma conta.  </td><td>    Exiba e edite a página de contas de teste do Xbox de uma conta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Contas de teste do Xbox por área restrita</b>&nbsp;*</td><td>    Pode exibir a página de contas de teste do Xbox para apenas de uma conta de áreas de segurança especificadas.  </td><td>    Exiba e edite o teste do Xbox.   <tr><td align="left">    <b>Página de contas para apenas as áreas de segurança especificadas de uma conta    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Dispositivos do Xbox</b>&nbsp;*</td><td>    Pode exibir a página de consoles Xbox um desenvolvimento de uma conta.  </td><td>    Pode exibir e editar a página de consoles Xbox um desenvolvimento de uma conta.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Dispositivos do Xbox por área restrita</b>&nbsp;*</td><td>    Pode exibir a página de consoles Xbox um desenvolvimento para apenas de uma conta de áreas de segurança especificadas.  </td><td>    Pode exibir e editar a página de consoles Xbox um desenvolvimento para apenas de uma conta de áreas de segurança especificadas.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    ...
    <tr><td align="left">    <b>Configuração de serviço</b>&nbsp;*</td><td>    Pode exibir a página de configuração de serviço do Xbox Live de um produto.  </td><td>    Pode exibir e editar a página de configuração de serviço do Xbox Live de um produto.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
    <tr><td align="left">    <b>Ferramentas de acesso</b>&nbsp;*</td><td>    Pode executar o Xbox Live ferramentas em um produto para exibir apenas os dados.  </td><td>    Pode executar as ferramentas do Xbox Live em um produto para exibir e editar dados.    </td><td>    N/D    </td><td>    N/D                      </td></tr>
</tbody>
</table>
