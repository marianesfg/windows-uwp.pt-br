...
Quando seu app terminar de usar o **MediaPlayer**, você deverá chamar o método [**Close**](https://msdn.microsoft.com/library/windows/apps/Windows.Media.Playback.MediaPlayer.Close) (projetado como **Dispose** em C#) para limpar os recursos usados pelo player.
...
Defina a propriedade [**AudioCategory**](https://msdn.microsoft.com/library/windows/apps/Windows.Media.Playback.MediaPlayer.AudioCategory) de um **MediaPlayer** como um dos valores da enumeração [**MediaPlayerAudioCategory**](https://msdn.microsoft.com/library/windows/apps/Windows.Media.Playback.MediaPlayerAudioCategory) para informar o sistema qual tipo de mídia você está executando. Jogos devem categorizar seus fluxos de música como **GameMedia** para que o mudo do jogo seja ativado automaticamente se outro app reproduzir música em segundo plano. Os apps de música ou vídeo devem categorizar seus fluxos como **Media** ou **Movie** para que eles tenham prioridade sobre fluxos **GameMedia**.
