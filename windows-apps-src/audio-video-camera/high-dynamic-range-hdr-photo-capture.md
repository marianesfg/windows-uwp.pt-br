...
A partir do Windows 10, versão 1607, o **AdvancedPhotoCapture** pode ser usado para capturar fotos usando um algoritmo interno que melhora a qualidade das fotos capturadas nas configurações de pouca luz.

> [!NOTE] 
> Não há suporte para gravação de vídeo e captura de foto simultâneas usando **AdvancedPhotoCapture**.

> [!NOTE] 
> Se a propriedade [**FlashControl.Enabled**](https://msdn.microsoft.com/library/windows/apps/Windows.Media.Devices.FlashControl.Enabled) for definida como true, ela substituirá as configurações de **AdvancedPhotoCapture** e fará com que uma foto normal seja capturada com flash. Se [**Auto**](https://msdn.microsoft.com/library/windows/apps/Windows.Media.Devices.FlashControl.Auto) for definido como true, o **AdvancedPhotoCapture** será usado conforme configurado e o flash não será usado.
