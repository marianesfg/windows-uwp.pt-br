...
Por fim, o conjunto de propriedades que inclui os dados de orientação é definido para o codificador com uma chamada para [**SetPropertiesAsync**](https://developer.microsoft.com/windows/apps/develop) e a imagem é transcodificada com uma chamada para [**FlushAsync**](https://docs.microsoft.com/uwp/api/windows.graphics.imaging.bitmapencoder.flushasync).
