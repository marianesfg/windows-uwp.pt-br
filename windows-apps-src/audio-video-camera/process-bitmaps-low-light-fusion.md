...
Aqui está um exemplo das duas imagens de entrada e da imagem de saída resultante da aplicação do algoritmo Low Light Fusion.

> [!div class="mx-tableFixed"] 
| Quadro 1 | Quadro 2 | Saída do Low Light Fusion | 
|---------|---------|-------------------------|
| ![Primeiro quadro de entrada no algoritmo Low Light Fusion](./images/LLF-Input1.png) | ![Segundo quadro de entrada no algoritmo Low Light Fusion](./images/LLF-Input2.png) | ![Quadro resultante do algoritmo Low Light Fusion](./images/LLF-Output.png) |

Você pode ver, nos quadros de entrada e no quadro de saída, que a iluminação e a claridade da xícara foi aprimorada, bem como a claridade das imediações, como a modelagem ao lado do tapete.
