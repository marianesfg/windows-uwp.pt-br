...
A maneira mais simples para converter a mídia de um Aplicativo Universal do Windows é usar a funcionalidade de transmissão interna do controle do [**MediaElement**](https://msdn.microsoft.com/library/windows/apps/br242926).

Para permitir que o usuário abra um arquivo de vídeo a ser reproduzido no controle do **MediaElement**, adicione os seguintes namespaces ao seu projeto.

[!code-cs[BuiltInCastingUsing](./code/MediaCastingWin10/cs/MainPage.xaml.cs#SnippetBuiltInCastingUsing)]

No arquivo XAML do seu aplicativo, adicione um **MediaElement** e defina [**AreTransportControlsEnabled**](https://msdn.microsoft.com/library/windows/apps/dn298977) como verdadeiro.
...
Depois que o vídeo é carregado no **MediaElement**, o usuário pode simplesmente pressionar o botão de transmissão nos controles de transporte para iniciar uma caixa de diálogo interna que permita a eles escolher um dispositivo para o qual a mídia carregada será convertida.

![mediaelement casting button (botão de transmissão MediaElement)](images/media-element-casting-button.png)
