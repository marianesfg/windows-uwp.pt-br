...
description: Saiba como usar as transformações na API&\#160;Windows Runtime, alterando o sistema de coordenadas relativas de elementos na interface do usuário.
---
...
* [Efeitos em perspectiva 3D para interface do usuário XAML](3-d-perspective-effects.md)
