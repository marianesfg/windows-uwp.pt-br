...
-   [Gestos de passar o dedo](./animations-overview.md#swipe-gestures): indica que um bloco suporta a interação com o dedo ou o estado de selecionado com o dedo
