...
description: a API Windows.UI.Composition fornece interfaces de interoperação nativa, e, que permitem que o conteúdo seja movido diretamente para o compositor.
---
