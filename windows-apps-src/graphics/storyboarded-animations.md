...
Consultemos um exemplo simples. Neste XAML de exemplo, a propriedade [**Opacity**](https://msdn.microsoft.com/library/windows/apps/BR208962) é animada em um objeto [**Rectangle**](https://msdn.microsoft.com/library/windows/apps/BR243371) específico.
...
Consulte a seguir uma lista dos cenários de direcionamento de animação em que você provavelmente usará o direcionamento indireto de propriedades e algumas cadeias de caracteres de caminho de propriedade semelhantes à sintaxe que usará:
...
-   Animando um [**Color**](https://msdn.microsoft.com/library/windows/apps/BR242963) em um [**GradientStop**](https://msdn.microsoft.com/library/windows/apps/BR210078) de um [**LinearGradientBrush**](https://msdn.microsoft.com/library/windows/apps/BR210108), conforme aplicado a um [**Fill**](https://msdn.microsoft.com/library/windows/apps/BR243378): `(Shape.Fill).(GradientBrush.GradientStops)[0].(GradientStop.Color)`
...
-   [
              **Double**
            ](https://msdn.microsoft.com/library/windows/apps/xaml/system.double.aspx) pode ser animado com qualquer [**DoubleAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243136)
-   [
              **Point**
            ](https://msdn.microsoft.com/library/windows/apps/BR225870) pode ser animado com qualquer [**PointAnimation**](https://msdn.microsoft.com/library/windows/apps/BR210346)
-   [
              **Color**
            ](https://msdn.microsoft.com/library/windows/apps/Hh673723) pode ser animado com qualquer [**ColorAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243066)
...
Vamos revisar o exemplo de XAML anterior e observar novamente os valores **From**, **To** e **Duration**. O exemplo anima a propriedade [**Opacity**](https://msdn.microsoft.com/library/windows/apps/BR208962) e o tipo de **Opacity** é [**Double**](https://msdn.microsoft.com/library/windows/apps/xaml/system.double.aspx). Assim, a animação a ser usada aqui é [**DoubleAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243136)

`From="1.0" To="0.0"` especifica que, quando a animação for executada, a propriedade [**Opacity**](https://msdn.microsoft.com/library/windows/apps/BR208962) comece no valor 1 e seja animada em 0. Em outras palavras, em termos do que esses valores [**Double**](https://msdn.microsoft.com/library/windows/apps/xaml/system.double.aspx) significam para a propriedade **Opacity**, essa animação fará com que o objeto comece opaco e depois fique transparente.
...
**Observação**  Para o exemplo mostrado, se você tivesse certeza de que o estado inicial do objeto sendo animado tem [**Opacity**](https://msdn.microsoft.com/library/windows/apps/BR208962) sempre igual a 1 através do padrão ou de uma definição explícita, poderia omitir o valor **From**, a animação usaria o valor inicial implícito e o resultado seria o mesmo.
...
-   A animação direciona [**UIElement.Opacity**](https://msdn.microsoft.com/library/windows/apps/BR208962)
...
-   A animação direciona um valor [**Brush**](https://msdn.microsoft.com/library/windows/apps/BR228076) e usa um [**SolidColorBrush**](https://msdn.microsoft.com/library/windows/apps/BR242962), animando seu [**Color**](https://msdn.microsoft.com/library/windows/apps/BR242963)
-   A animação é um [**ObjectAnimationUsingKeyFrames**](https://msdn.microsoft.com/library/windows/apps/BR210320)

**Cuidado**  Para que sua animação seja tratada como independente, você deve definir explicitamente a `Duration="0"`. Por exemplo, se você remover a `Duration="0"` desse XAML, a animação será tratada como dependente, mesmo que o [**KeyTime**](https://msdn.microsoft.com/library/windows/apps/BR243169) do quadro seja "0:0:0".
...
* [Sintaxe de caminho de propriedade](https://msdn.microsoft.com/library/windows/apps/Mt185586)
