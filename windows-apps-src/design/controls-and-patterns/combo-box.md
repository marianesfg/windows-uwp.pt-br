...
Este examle, um seletor de tamanho de fonte contém um conjunto de valores correspondentes da rampa de tamanho de fonte, mas o usuário poderá digitar tamanhos de fonte que não estão na lista.
