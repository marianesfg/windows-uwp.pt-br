...
> **APIs importantes**: [Classe TimePicker](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.TimePicker), [propriedade de tempo](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.timepicker.time)
