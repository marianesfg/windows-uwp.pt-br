...
TabView oferece guias de documento para aplicativos UWP. Use um TabView quando:
...
Este exemplo cria um TabView simples junto com manipuladores de evento para dar suporte à abertura e ao fechamento de guias.
...
Como a barra de guias fica cheia, é possível controlar como elas são exibidas definindo TabView.TabWidthMode.
