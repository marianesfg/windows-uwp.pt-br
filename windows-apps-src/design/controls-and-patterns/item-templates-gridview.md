---
Description: Modelos de item para exibição de grade
title: Modelos de item para exibição de grade
template: detail.hbs
ms.date: 11/03/2017
ms.topic: article
...
![exemplo de gridview pequeno de ícone e texto](images/listitems/icontext.png)
```xaml
