...
Normalmente, existem duas maneiras invocar um submenu ou um menu que está associado a um elemento na sua tela de interface do usuário: _invocação proativa_ e _invocação reativa_.
