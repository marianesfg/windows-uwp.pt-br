...
Este XAML mostra os objetos [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) para os estados `Checked`, `Unchecked` e `Indeterminate`. O exemplo define a propriedade [**VisualStateManager.VisualStateGroups**](https://docs.microsoft.com/dotnet/api/system.windows.visualstatemanager) anexada no [**Border**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Border), que é o elemento raiz do [**ControlTemplate**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ControlTemplate). O `Checked` **VisualState** especifica que a [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) do [**Path**](/uwp/api/Windows.UI.Xaml.Shapes.Path) chamado `CheckGlyph` (que mostramos no exemplo anterior) é 1. O `Indeterminate` **VisualState** especifica que a **Opacity** da [**Ellipse**](/uwp/api/Windows.UI.Xaml.Shapes.Ellipse) chamada `IndeterminateGlyph` é 1. O `Unchecked` **VisualState** não tem nenhum [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) ou [**Storyboard**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.Storyboard) e, portanto, a [**CheckBox**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.CheckBox) volta à aparência padrão.
...
| De `Unchecked` a `Checked`.       | O valor [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) do `Checked` [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) é aplicado e, portanto, a [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `CheckGlyph` é 1.                                                                                                                                                         | Um X é exibido.                                |
| De `Checked` a `Indeterminate`.   | O valor [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) do `Indeterminate` [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) é aplicado e, portanto, a [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` é 1. O valor **Setter** do `Checked` **VisualState** é removido e, portanto, a [**Opacity**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.opacity) de `CheckGlyph` é 0. | Um círculo é exibido.                            |
| De `Indeterminate` a `Unchecked`. | O valor [**Setter**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) do `Indeterminate` [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) é removido e, portanto, a [**Opacity**](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` é 0.                                                                                                                                           | Nada é exibido.                             |
...
* [Amostra do XAML Controls Gallery](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/XamlUIBasics)
* [Exemplo de controle de edição de texto personalizado](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/CustomEditControl)
