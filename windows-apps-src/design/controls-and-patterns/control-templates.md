...
> **APIs importantes**: [**Classe de ControlTemplate**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ControlTemplate), [ **propriedade Control.** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control.template)
...
> [!NOTE]
> Começando com o Windows 10, versão 1809 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk)), você pode usar [ **X:Bind** ](https://docs.microsoft.com/windows/uwp/xaml-platform/x-bind-markup-extension) extensões de marcação em lugares que você usa [TemplateBinding](../../xaml-platform/templatebinding-markup-extension.md) . Consulte [TemplateBinding markup extension](../../xaml-platform/templatebinding-markup-extension.md) para mais informações.
...
Este XAML mostra os objetos [**VisualState**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) para os estados `Checked`, `Unchecked` e `Indeterminate`. O exemplo define a propriedade [**VisualStateManager.VisualStateGroups**](https://docs.microsoft.com/dotnet/api/system.windows.visualstatemanager?view=netframework-4.8) anexada no [**Border**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Border), que é o elemento raiz do [**ControlTemplate**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.ControlTemplate). O `Checked` **VisualState** Especifica que o [ **opacidade** ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) do [ **caminho** ](/uwp/api/Windows.UI.Xaml.Shapes.Path) chamado `CheckGlyph` (que é mostrada no exemplo anterior) é 1. O `Indeterminate` **VisualState** Especifica que o **opacidade** do [ **elipse** ](/uwp/api/Windows.UI.Xaml.Shapes.Ellipse) chamado `IndeterminateGlyph` é 1. O `Unchecked` **VisualState** não tem nenhum [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) ou [ **Storyboard**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.Storyboard), portanto, a [ **Caixa de seleção** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.CheckBox) retorna à sua aparência padrão.
...
| De `Unchecked` a `Checked`.       | O [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) valor da `Checked` [ **VisualState** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) é aplicado, portanto, a [ **opacidade**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `CheckGlyph` é 1.                                                                                                                                                         | Um X é exibido.                                |
| De `Checked` a `Indeterminate`.   | O [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) valor da `Indeterminate` [ **VisualState** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) é aplicado, portanto, a [ **opacidade**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` é 1. O **Setter** valor da `Checked` **VisualState** for removido, portanto, o [ **opacidade** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush.opacity) de `CheckGlyph` é 0. | Um círculo é exibido.                            |
| De `Indeterminate` a `Unchecked`. | O [ **Setter** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Setter) valor da `Indeterminate` [ **VisualState** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.VisualState) é removida, portanto, a [ **opacidade**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` é 0.                                                                                                                                           | Nada é exibido.                             |
