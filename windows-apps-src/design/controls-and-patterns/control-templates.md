...
> **APIs importantes**: [**Classe de ControlTemplate**](https://msdn.microsoft.com/library/windows/apps/br209391), [ **propriedade Control.**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.controls.control.template.aspx)
...
> [!NOTE]
> Começando com o Windows 10, versão 1809 ([SDK 17763](https://developer.microsoft.com/windows/downloads/windows-10-sdk)), você pode usar [ **X:Bind** ](https://msdn.microsoft.com/library/windows/apps/Mt204783) extensões de marcação em lugares que você usa [TemplateBinding](../../xaml-platform/templatebinding-markup-extension.md) . Consulte [TemplateBinding markup extension](../../xaml-platform/templatebinding-markup-extension.md) para mais informações.
...
Este XAML mostra os objetos [**VisualState**](https://msdn.microsoft.com/library/windows/apps/br209007) para os estados `Checked`, `Unchecked` e `Indeterminate`. O exemplo define a propriedade [**VisualStateManager.VisualStateGroups**](https://msdn.microsoft.com/library/windows/apps/hh738505) anexada no [**Border**](https://msdn.microsoft.com/library/windows/apps/br209250), que é o elemento raiz do [**ControlTemplate**](https://msdn.microsoft.com/library/windows/apps/br209391). O `Checked` **VisualState** Especifica que o [ **opacidade** ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) do [ **caminho** ](/uwp/api/Windows.UI.Xaml.Shapes.Path) chamado `CheckGlyph` (que é mostrada no exemplo anterior) é 1. O `Indeterminate` **VisualState** Especifica que o **opacidade** do [ **elipse** ](/uwp/api/Windows.UI.Xaml.Shapes.Ellipse) chamado `IndeterminateGlyph` é 1. O `Unchecked` **VisualState** não tem nenhum [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) ou [ **Storyboard**](https://msdn.microsoft.com/library/windows/apps/br210490), portanto, a [ **Caixa de seleção** ](https://msdn.microsoft.com/library/windows/apps/br209316) retorna à sua aparência padrão.
...
| De `Unchecked` a `Checked`.       | O [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) valor da `Checked` [ **VisualState** ](https://msdn.microsoft.com/library/windows/apps/br209007) é aplicado, portanto, a [ **opacidade**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `CheckGlyph` é 1.                                                                                                                                                         | Um X é exibido.                                |
| De `Checked` a `Indeterminate`.   | O [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) valor da `Indeterminate` [ **VisualState** ](https://msdn.microsoft.com/library/windows/apps/br209007) é aplicado, portanto, a [ **opacidade**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` é 1. O **Setter** valor da `Checked` **VisualState** for removido, portanto, o [ **opacidade** ](https://msdn.microsoft.com/library/windows/apps/br228078) de `CheckGlyph` é 0. | Um círculo é exibido.                            |
| De `Indeterminate` a `Unchecked`. | O [ **Setter** ](https://msdn.microsoft.com/library/windows/apps/br208817) valor da `Indeterminate` [ **VisualState** ](https://msdn.microsoft.com/library/windows/apps/br209007) é removida, portanto, a [ **opacidade**  ](/uwp/api/Windows.UI.Xaml.UIElement.Opacity) de `IndeterminateGlyph` é 0.                                                                                                                                           | Nada é exibido.                             |
...
* [Exemplo da Galeria de controles XAML](https://github.com/Microsoft/Windows-universal-samples/blob/master/Samples/XamlUIBasics)
