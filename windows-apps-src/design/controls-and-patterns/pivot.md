...
ms.locfileid: "3962588"
---
# <a name="pivot"></a>Pivot

O controle de [pivô](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Controls.Pivot) permite toque-passar o dedo entre um pequeno conjunto de seções de conteúdo.
