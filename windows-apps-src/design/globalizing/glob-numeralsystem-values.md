---
Description: Este tópico lista os valores disponíveis para a propriedade NumeralSystem de classes no namespace Windows.Globalization.
...
| Java | Javanês | U+A9D0, U+A9D1, U+A9D2, U+A9D3, U+A9D4, U+A9D5, U+A9D6, U+A9D7, U+A9D8, U+A9D9 |
...
| Mlym | malaiala | U+0D66, U+0D67, U+0D68, U+0D69, U+0D6A, U+0D6B, U+0D6C, U+0D6D, U+0D6E, U+0D6F |
