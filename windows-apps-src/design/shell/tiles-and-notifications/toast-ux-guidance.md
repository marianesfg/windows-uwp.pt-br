...
* Embutido respondendo às mensagens, emails, chats grupo, comentários, etc.
...
Ambas essas notificações gorup de uma maneira para que o conteúdo relevante permanece juntos (isto é, pense separando ligas esportes diferentes em um aplicativo de esportes ou classificar mensagens por bate-papo de grupo). Coleções são uma maneira mais óbvia para notificações de grupo, enquanto os cabeçalhos são mais sutis, mas ambas permitem que os usuários façam triagem e escolha as notificações mais rapidamente. 
