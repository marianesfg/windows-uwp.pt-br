...
UWP ajuda ajustando automaticamente elementos de interface do usuário para que seja legível e fácil de interagir com em todos os dispositivos e tamanhos de tela.
