...
* Padrões de controle de automação da interface do usuário: Um tipo de controle pode dar suporte a mais de um padrão, cada um representando uma classificação diferente de informações ou interação. Cada tipo de controle possui um conjunto de padrões que o controle tem que permitir, um conjunto opcional e um conjunto que o controle não deve permitir.
* Valores da propriedade de automação da interface do usuário: Cada tipo de controle tem um conjunto de propriedades para o qual o controle deve dar suporte. Estas são as propriedades gerais, como descrito na [Visão geral das propriedades da Automação da Interface do Usuário](https://docs.microsoft.com/windows/desktop/WinAuto/uiauto-propertiesoverview), e não são específicas ao padrão.
* Eventos de automação da interface do usuário: Cada tipo de controle tem um conjunto de eventos para o qual o controle deve dar suporte. Eles também são gerais, e não específicos ao padrão, conforme descrito na [Visão geral dos eventos de Automação da Interface do Usuário](https://docs.microsoft.com/windows/desktop/WinAuto/uiauto-eventsoverview).
* Estrutura da árvore de automação da interface do usuário: Cada tipo de controle define como o controle deve aparecer na estrutura da árvore de automação da interface do usuário.
...
* [Controlar padrões e interfaces](control-patterns-and-interfaces.md)
