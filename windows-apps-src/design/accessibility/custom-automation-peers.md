...
* [**GetBoundingRectangleCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getboundingrectanglecore): Retorna um [ **Rect** ](https://msdn.microsoft.com/library/windows/apps/BR225994) estrutura com base nas características de layout conhecidos. Retorna um valor de 0 **Rect** se [**IsOffscreen**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isoffscreen) é **true**.
* [**GetClickablePointCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getclickablepointcore): Retorna um [ **ponto** ](https://msdn.microsoft.com/library/windows/apps/BR225870) estrutura com base em características conhecidas de layout, desde que haja em uma diferente de zero **BoundingRectangle**.
* [**GetNameCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getnamecore): Comportamento mais abrangente que pode ser resumido aqui; ver [ **GetNameCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getnamecore). Basicamente, é tentada uma conversão de cadeia de caracteres em qualquer conteúdo conhecido de um [**ContentControl**](https://msdn.microsoft.com/library/windows/apps/BR209365) ou de classes relacionadas que têm conteúdo. Além disso, quando há um valor de [**LabeledBy**](https://msdn.microsoft.com/library/windows/apps/Hh759769), o valor de **Name** desse item é usado como **Name**.
* [**HasKeyboardFocusCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.haskeyboardfocuscore): Avaliado com base em que o proprietário [ **FocusState** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.control.focusstate) e [ **Estáativado** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.control.isenabled) propriedades. Os elementos que não são controles sempre retornam **false**.
* [**IsEnabledCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isenabledcore): Avaliado com base em que o proprietário [ **IsEnabled** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.control.isenabled) propriedade se ele é um [ **controle**](https://msdn.microsoft.com/library/windows/apps/BR209390). Os elementos que não são controles sempre retornam **true**. Isso não significa que o proprietário está habilitado do ponto de vista da interação convencional. Significa que o par está habilitado, mesmo que o proprietário não tenha uma propriedade **IsEnabled**.
* [**IsKeyboardFocusableCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.iskeyboardfocusablecore): Retorna **verdadeira** se o proprietário é um [ **controle**](https://msdn.microsoft.com/library/windows/apps/BR209390); caso contrário, será **false**.
* [**IsOffscreenCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isoffscreencore): Um [ **visibilidade** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.uielement.visibility) dos [ **recolhido** ](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.visibility) sobre o proprietário do elemento ou qualquer um de seus pais é igual a um **true** o valor para [ **IsOffscreen**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.isoffscreen). Exceção: um objeto [**Popup**](https://msdn.microsoft.com/library/windows/apps/BR227842) pode estar visível, mesmo que os pais de seu proprietário não estejam.
* [**SetFocusCore**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.setfocuscore): Chamadas [ **foco**](https://msdn.microsoft.com/library/windows/apps/hh702161).
* [**GetParent**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.automation.peers.automationpeer.getparent): Chamadas [ **FrameworkElement.Parent** ](https://msdn.microsoft.com/library/windows/apps/BR208739) do proprietário e procura o par apropriado. Este não é um par de substituição com um método "Core". Por isso, você não pode alterar esse comportamento.
