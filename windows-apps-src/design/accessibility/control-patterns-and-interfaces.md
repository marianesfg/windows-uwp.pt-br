...
| **Planilha** | [**ISpreadsheetProvider**](https://msdn.microsoft.com/library/windows/apps/Dn251821) | Usado para expor o conteúdo de uma folha de cálculo ou de outro documento baseado em grade. |
...
| **Item de tabela** | [**ITableItemProvider**](https://msdn.microsoft.com/library/windows/apps/BR242620) | Usado para itens em uma tabela. |
...
| **Editor de texto** | Não há classe gerenciada disponível | Fornece acesso a um controle que modifica o texto, por exemplo, um controle que executa correção automática ou permite a composição de entrada através de um IME (Editor de Método de Entrada). |
...
| **Janela** | [**IWindowProvider**](https://msdn.microsoft.com/library/windows/apps/BR242670) | Expõe as informações específicas do windows, um conceito fundamental para o sistema operacional Microsoft Windows. Exemplos de controles que são janelas filho e caixas de diálogo. |
