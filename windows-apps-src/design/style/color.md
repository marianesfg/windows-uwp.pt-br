...
Configuração que X:Key garantirá que suas cores alterar adequadamente para o tema do sistema ou aplicativo, caso você queira uma aparência personalizada diferente quando no tema.
