---
author: mijacobs
description: Um tipo de pincel que cria uma textura parcialmente transparente.
...
<td>
    <p>Se você tem um aplicativo <strong style="font-weight: semi-bold">XAML Controls Gallery</strong> instalado, clique aqui para <a href="xamlcontrolsgallery:/item/Acrylic">abrir o aplicativo e ver o Acrílico em ação</a>.</p>
    <ul>
...
<table>
    ...
    <tr>
        <td> <b>Uso recomendado:</b> Se o seu aplicativo utiliza texto secundário de cor AltMedium com um tamanho de 18px ou maior, você pode colocar esses recursos acrílicos de 70% atrás do texto. Recomendamos usar esses recursos nas áreas de navegação e comando horizontais superiores do seu aplicativo.  </td>
    </tr>
    <tr>
