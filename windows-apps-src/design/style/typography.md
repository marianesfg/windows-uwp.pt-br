...
<div class="uwpd-image-with-caption">
    ...
    <div>Todos os tamanhos estão em pixels efetivos. Para obter mais detalhes, consulte [Introdução ao design de aplicativos UWP](../basics/design-and-ui-intro.md).</div>
</div>
...
Para criar hierarquia adicional além da rampa de tipos, defina o texto secundário com opacidade de 60%. Na [paleta de cores de temas](color.md#themes), você usaria BaseMedium. O texto principal deve ter sempre 100% de opacidade ou BaseHigh.
