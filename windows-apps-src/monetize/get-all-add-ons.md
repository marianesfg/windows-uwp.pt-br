...
Use este método na API de envio da Windows Store para recuperar dados para todos os complementos para todos os aplicativos que estão registrados em sua conta do Centro de Desenvolvimento do Windows.
