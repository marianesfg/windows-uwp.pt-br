...
description: "Use este método na API de análise da Windows Store para obter dados detalhados de um erro específico de hardware. Esse método destina-se apenas para OEMs."
