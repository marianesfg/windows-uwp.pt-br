...
Use os métodos a seguir para obter, criar, atualizar, confirmar ou excluir um envio de complemento. Antes de usar esses métodos, o complemento já deve existir na conta do Centro de Desenvolvimento. Você pode criar um complemento no painel ao [definir o tipo de produto e a ID de produto](../publish/set-your-add-on-product-id.md) ou usar os métodos da API de envio da Windows Store descritos em [Gerenciar complementos](manage-add-ons.md).
...
<td align="left">[Obter um envio de complemento existente](get-an-add-on-submission.md)</td>
</tr>
<tr>
<td align="left">GET</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts/{id}/submissions/{submissionId}/status```</td>
<td align="left">[Obter o status de um envio de complemento existente](get-status-for-an-add-on-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts/{id}/submissions```</td>
<td align="left">[Criar um novo envio de complemento](create-an-add-on-submission.md)</td>
</tr>
<tr>
<td align="left">PUT</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts/{id}/submissions/{submissionId}```</td>
<td align="left">[Atualizar um envio de complemento existente](update-an-add-on-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts/{id}/submissions/{submissionId}/commit```</td>
<td align="left">[Confirmar um envio de complemento novo ou atualizado](commit-an-add-on-submission.md)</td>
</tr>
<tr>
<td align="left">DELETE</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts/{id}/submissions/{submissionId}```</td>
<td align="left">[Excluir um envio de complemento](delete-an-add-on-submission.md)</td>
</tr>
</tbody>
</table>
...
Os métodos da API de envio da Windows Store para gerenciar envios do pacote de complemento usam os recursos de dados JSON a seguir.
...
Esse recurso contém informações de detalhes de um complemento. Esse recurso tem os valores a seguir.
...
> [!IMPORTANT]
> O recurso **Venda** não tem mais suporte, e atualmente você não pode acessar nem modificar os dados de venda de um envio de complemento usando a API de envio da Windows Store. No futuro, atualizaremos a API de envio da Windows Store para apresentar uma nova maneira de acessar programaticamente as informações de vendas para envios de complemento.
...
>    * Ao chamar o [método PUT para atualizar um envio de complemento](update-an-add-on-submission.md), as informações no valor de *sales* serão ignoradas. Você pode continuar usando o painel do Centro de Desenvolvimento para alterar os dados de venda para a submissão do suplemento.
