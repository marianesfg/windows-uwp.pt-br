...
Use os métodos a seguir para obter, criar, atualizar, confirmar ou excluir um envio de complemento.
...
| friendlyName  | string  |  O nome amigável do complemento, usado para fins de exibição.  |
