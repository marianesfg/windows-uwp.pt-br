...
|  lifetimeBudget   |  decimal   |   O orçamento vitalício da linha de entrega. É necessário definir lifetimeBudget* ou *dailyBudget*.      |    Não   |      |   POST, PUT (se *dailyBudget* não estiver definido)    |
