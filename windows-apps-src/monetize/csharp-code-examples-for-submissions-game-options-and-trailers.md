---
author: mcleanbyron
description: "Use os exemplos de código C# nesta seção para saber mais sobre como enviar opções de jogo e trailers usando a API de envio da Windows Store."
...
ms.prod: windows
ms.technology: uwp
keywords: "Windows 10, uwp, API de envio da Windows Store, exemplos de código, opções de jogos, trailers, listagens avançadas, C#"
...
A classe ```CreateAndSubmitSubmissionExample``` define um método ```Execute``` público que chama outros métodos de exemplo para usar a API de envio da Windows Store para criar e confirmar um envio de aplicativo que contém as opções de jogo e um trailer. Para adaptar este código para seu próprio uso:
