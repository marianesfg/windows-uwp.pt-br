...
description: Use esse método na API de análise de Microsoft Store para obter dados de uso diário do aplicativo para um determinado intervalo de datas e outros filtros opcionais.
...
| dailySessionCount         | long    | O número de sessões de usuário naquele dia.                                  |
...
| dailyActiveUsers          | long    | O número de clientes que usam o aplicativo nesse dia.                           |
| dailyActiveDevices        | long    | O número de dispositivos de diários usado para interagir com seu aplicativo por todos os usuários.  |
| dailyNewUsers             | long    | O número de clientes que usaram o aplicativo pela primeira vez nesse dia.    |
...
* [Obter ussage mensal de aplicativo](get-app-usage-monthly.md)
