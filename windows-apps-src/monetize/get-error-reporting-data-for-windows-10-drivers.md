...
Use este método na API de análise da Microsoft Store para obter dados de relatório de erros agregados do driver do Windows 10 para um determinado intervalo de datas e outros filtros opcionais. Você pode recuperar mais informações de erro usando o método [obter detalhes de um erro de driver do Windows 10](get-details-for-a-windows-10-driver-error.md).
