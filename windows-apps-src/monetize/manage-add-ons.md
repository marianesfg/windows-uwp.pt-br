...
<td align="left">[Obter um complemento específico](get-an-add-on.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts```</td>
<td align="left">[Criar um complemento](create-an-add-on.md)</td>
</tr>
<tr>
<td align="left">DELETE</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/inappproducts/{inAppProductId}```</td>
<td align="left">[Excluir um complemento](delete-an-add-on.md)</td>
</tr>
</tbody>
</table>
...
Os métodos da API de envio da Windows Store para gerenciar complementos usam os recursos de dados JSON a seguir.
