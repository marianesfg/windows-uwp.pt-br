...
description: "Use este método na API de análise da Windows Store para obter dados detalhados de um erro de driver do Windows 7 ou Windows 8. x. Esse método destina-se apenas para IHVs."
