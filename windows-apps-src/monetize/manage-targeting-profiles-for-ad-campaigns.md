...
Para saber mais sobre a relação entre perfis de direcionamento e campanhas publicitárias, linhas de entrega e criativos, consulte [Veicular campanhas publicitárias usando serviços da Windows Store](run-ad-campaigns-using-windows-store-services.md#call-the-windows-store-promotions-api).
