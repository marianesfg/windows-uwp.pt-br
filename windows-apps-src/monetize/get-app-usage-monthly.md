...
O exemplo a seguir demonstra uma solicitação de obtenção de dados mensal de uso do aplicativo. Substitua o valor de *applicationId* pela ID da Loja do seu app.
