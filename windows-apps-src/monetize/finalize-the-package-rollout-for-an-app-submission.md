...
# Finalizar a distribuição de pacote para um envio de aplicativo usando a API de envio da Windows Store
...
Se a solicitação não tiver sido concluída com êxito, a resposta conterá um dos seguintes códigos de erro HTTP.
