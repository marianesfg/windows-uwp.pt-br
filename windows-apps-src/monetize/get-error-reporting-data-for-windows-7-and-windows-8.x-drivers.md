...
Use este método na API de análise da Microsoft Store para obter dados de relatório de erros agregados dos drivers do Windows 7/Windows 8.x para um determinado intervalo de datas e outros filtros opcionais. Você pode recuperar mais informações de erro usando o método [obter detalhes de um erro de driver do Windows 7 ou Windows 8.x](get-details-for-a-windows-7-or-windows-8.x-driver-error.md).
