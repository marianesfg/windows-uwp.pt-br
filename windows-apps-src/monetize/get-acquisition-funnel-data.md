---
author: mcleanbyron
description: "Use este método na API de análise da Windows Store para obter os dados de funil de aquisição de um aplicativo durante um determinado intervalo de datas e outros filtros opcionais."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, serviços da Loja, API de análise da Windows Store, aquisição, funil"
...
Veja alguns exemplos dos parâmetros *filter*.
