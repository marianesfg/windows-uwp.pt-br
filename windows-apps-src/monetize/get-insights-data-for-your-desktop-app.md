...
O exemplo a seguir demonstra uma solicitação de obtenção de dados de percepções. Substitua o valor *applicationId* com o valor apropriado para seu aplicativo da área de trabalho.
