...
| addonProductName    | string  | O nome de exibição do complemento. Esse valor só aparece nos dados de resposta se o parâmetro *aggregationLevel* for definido como **dia**, a menos que você especifique o campo **addonProductName** no parâmetro *groupby* .                                                                                                                                                                                                            |
