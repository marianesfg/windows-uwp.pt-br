...
ms.locfileid: "4957277"
---
# <a name="error-codes-for-store-operations"></a>Códigos de erro para operações da Microsoft Store

<!-- confirm whether symbolic names are defined for app developers, or do they just handle direct error code values -->

Este artigo descreve os códigos de erro comuns que podem ocorrer enquanto você estiver desenvolvendo ou testes operações relacionadas à loja em seu aplicativo.

## <a name="in-app-purchase-error-codes"></a>Códigos de erro de compra no aplicativo

Os seguintes códigos de erro estão relacionados às operações de compra no aplicativo.
...
| 0x803F6103   | O produto especificado não pôde ser encontrado. O produto não estará disponível na loja, ou talvez você tenha fornecido a ID da loja errado para o produto.                                          |
...
| 0x803F6108   | A compra no aplicativo não pôde ser concluída porque a licença do aplicativo não tem informações. Esse erro pode ocorrer quando você sideload seu aplicativo. Para resolver esse problema, desinstale o aplicativo e reinstale-lo da loja para atualizar a licença do aplicativo.                                          |
...
Os seguintes códigos de erro estão relacionados ao licenciamento operações para aplicativos ou complementos.
