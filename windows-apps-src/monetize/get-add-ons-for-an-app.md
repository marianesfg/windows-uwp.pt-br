...
Use este método na API de envio da Windows Store para listar os complementos para um aplicativo que está registrado à sua conta do Centro de Desenvolvimento do Windows.
