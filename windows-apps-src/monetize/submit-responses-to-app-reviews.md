...
>**Observação**&nbsp;&nbsp;além de usar esse método para responder às críticas de forma programada, você também pode responder às críticas [usando o painel do Centro de Desenvolvimento do Windows](../publish/respond-to-customer-reviews.md) como alternativa.

## <a name="prerequisites"></a>Pré-requisitos

Para usar este método, primeiro você precisa do seguinte:

* Se você não tiver feito isso, conclua todos os [pré-requisitos](respond-to-reviews-using-windows-store-services.md#prerequisites) para a API de análises da Windows Store.
