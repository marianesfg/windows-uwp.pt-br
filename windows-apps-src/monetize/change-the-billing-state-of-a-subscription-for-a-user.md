...
description: "Use este método na API de compra da Windows Store para alterar o estado de cobrança de uma assinatura para um usuário."
...
ms.prod: windows
ms.technology: uwp
keywords: windows 10, uwp, API de compra na Windows Store, assinaturas
...
Use este método na API de compra da Windows Store para alterar o estado de cobrança de um complemento de assinatura para um determinado usuário. Você pode cancelar, estender, reembolsar ou desabilitar a renovação automática de uma assinatura.
...
* Uma chave de ID da Windows Store que representa a identidade do usuário que tem direito à assinatura que deseja alterar.
...
|----------------|--------|---------------|----------|
| b2bKey         | cadeia | A [chave de ID da Windows Store](view-and-grant-products-from-a-service.md#step-4) que representa a identidade do usuário cuja assinatura deseja alterar.     | Sim      |
...
O exemplo a seguir demonstra como usar esse método para estender o período de inscrição por 5 dias. Substitua o valor *b2bKey* pela [chave ID da Windows Store](view-and-grant-products-from-a-service.md#step-4) que representa a identidade do usuário cuja assinatura você deseja alterar.
...
| productId | cadeia | A [ID da loja](in-app-purchases-and-trials.md#store-ids) para o [produto](in-app-purchases-and-trials.md#products-skus-and-availabilities) que representa o complemento de assinatura no catálogo da Windows Store. Um exemplo de ID da Loja para um produto é 9NBLGGH42CFD.     |
| skuId | cadeia |  A [ID da loja](in-app-purchases-and-trials.md#store-ids) para o [SKU](in-app-purchases-and-trials.md#products-skus-and-availabilities) que representa o complemento de assinatura no catálogo da Windows Store. Um exemplo de ID da Loja para SKU é 0010.    |
