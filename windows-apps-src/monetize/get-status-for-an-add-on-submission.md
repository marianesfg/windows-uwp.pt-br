...
| Nome        | Tipo   | Descrição                                                                 |
|---------------|--------|-----------------------------------------------------------------------------|
| inAppProductId | cadeia de caracteres | Obrigatório. A ID da Loja do complemento que contém o envio para o qual você deseja obter o status. A ID de Store está disponível no Partner Center.  |
...
| statusDetails           | objeto  |  Contém detalhes adicionais sobre o status do envio, incluindo informações sobre os erros. Para obter mais informações, consulte [Recurso de detalhes sobre o status](manage-add-on-submissions.md#status-details-object). |
