---
author: mcleanbyron
description: "Use os exemplos de código Python nesta seção para saber mais sobre como enviar opções de jogo e trailers usando a API de envio da Windows Store."
...
ms.prod: windows
ms.technology: uwp
keywords: "Windows 10, uwp, API de envio da Windows Store, exemplos de código, opções de jogos, trailers, listagens avançadas, python"
...
Esse código chama outras classes e funções de exemplo para usar a API de envio da Windows Store para criar e confirmar um envio de aplicativo que contém as opções de jogo e um trailer. Para adaptar este código para seu próprio uso:
...
* Atribua a variável ```application_id``` à [ID da Loja](in-app-purchases-and-trials.md#store_ids) do app para o qual você deseja criar um envio.
