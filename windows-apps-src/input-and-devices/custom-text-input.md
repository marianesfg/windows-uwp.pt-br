...
label: Entrada de texto personalizado
template: detail.hbs
---
...
![diagrama do fluxo de texto de exemplo](images/coretext/stream-2.png)
Há duas seleções: \[0, 1\] e \[6, 11\]. O controle de edição deve informar somente uma delas; \[0, 1\] ou \[6, 11\].
...
![diagrama do fluxo de texto de exemplo](images/coretext/stream-3.png)
...
![diagrama do fluxo de texto de exemplo](images/coretext/stream-5.png)
...
![diagrama do fluxo de texto de exemplo](images/coretext/stream-6.png)
O usuário pressiona a tecla de espaço, e um evento [**TextUpdating**](https://msdn.microsoft.com/library/windows/apps/dn958176) correspondente é acionado. O controle de edição aceita a atualização de texto. Esse é o estado do controle de edição para um breve momento antes de a correção ser concluída. O ponto de inserção está em \[4, 4\].

![diagrama do fluxo de texto de exemplo](images/coretext/stream-7.png)
Fora do manipulador de eventos [**TextUpdating**](https://msdn.microsoft.com/library/windows/apps/dn958176), o controle de edição faz a correção a seguir. Este é o estado do controle de edição após a correção estar concluída. O ponto de inserção está em \[5, 5\].

![diagrama do fluxo de texto de exemplo](images/coretext/stream-8.png)
Quando isso acontecer, você deverá chamar [**NotifyTextChanged**](https://msdn.microsoft.com/library/windows/apps/dn958172) usando estes argumentos:
