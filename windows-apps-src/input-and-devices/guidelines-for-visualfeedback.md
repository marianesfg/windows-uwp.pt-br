...
*Pressione o dedo para baixo em um item para iniciar a interação de autorrevelação para uma seleção. A interação de autorrevelação demonstra qual ação será executada no item.*
