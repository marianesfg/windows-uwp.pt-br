---
Description: Crie aplicativos da Plataforma Universal do Windows (UWP) que oferecem suporte a interações com dispositivos de caneta, incluindo tinta digital para escrita à mão e experiências de desenho.
title: Interações com caneta
...
Otimize o design do seu aplicativa da Plataforma Universal do Windows (UWP) para entrada touch e obtenha suporte básico padrão para caneta.

A plataforma de tinta do aplicativo UWP, juntamente com um dispositivo de caneta, oferece uma maneira natural de criar anotações manuscritas, desenhos e anotações. A plataforma dá suporte à captura de dados de tinta por entrada de digitalizador, geração de dados de tinta, renderização desses dados como traços de tinta no dispositivo de saída, gerenciamento dos dados de tinta e reconhecimento de manuscrito.
...
Além de servirem como [**dispositivo de ponteiro**](https://msdn.microsoft.com/library/windows/apps/br225633) (similar a mouse e touch), canetas costumam ser associadas à escrita e a desenho diretamente em uma tela usando tinta digital.

A Plataforma Universal do Windows (UWP), juntamente com um dispositivo de caneta, oferece uma maneira natural de criar anotações manuscritas e desenhos digitais. A plataforma dá suporte à captura de dados de tinta por entrada de digitalizador, gerenciamento e geração de dados de tinta, renderização desses dados como traços e conversão de tinta para texto através do reconhecimento de manuscrito.
...
<tr class="even">
<td align="left">O espaço em branco [<strong>InkCanvas</strong>] (https://msdn.microsoft.com/library/windows/apps/dn858535) com uma imagem em segundo plano.</td>
<td align="left">O [<strong>InkCanvas</strong>] (https://msdn.microsoft.com/library/windows/apps/dn858535) com traços de tinta.</td>
<td align="left">O [<strong>InkCanvas</strong>] (https://msdn.microsoft.com/library/windows/apps/dn858535) com um traço apagado.
<p>Observe como apagar opera em um traço inteiro, não em uma parte.</p></td>
</tr>
</tbody>
</table>
