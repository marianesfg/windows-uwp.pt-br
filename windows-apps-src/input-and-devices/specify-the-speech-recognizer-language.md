...
label: Especificar o idioma do reconhecedor de fala
template: detail.hbs
---
...
Um reconhecedor de fala usa o idioma do controle por voz do sistema como seu idioma de reconhecimento padrão. Esse idioma é definido pelo usuário na tela Configurações &gt; Sistema &gt; Controle por voz &gt; Idioma de fala do dispositivo.
...
## <span id="Confirm_an_installed_language"></span><span id="confirm_an_installed_language"></span><span id="CONFIRM_AN_INSTALLED_LANGUAGE"></span>Confirme um idioma instalado
...
## <span id="Specify_a_language"></span><span id="specify_a_language"></span><span id="SPECIFY_A_LANGUAGE"></span>Especifique um idioma
