...
Antes de usar o scanner de código de barras Bluetooth, você deve emparelhá-lo usando **Configurações gt _ dispositivos gt _ Bluetooth & outros dispositivos gt _ Adicionar Bluetooth ou outro dispositivo**.
