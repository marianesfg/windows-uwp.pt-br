...
Para obter completo, dados brutos do código de barras, podemos simplesmente converter o buffer que obtemos de **ScanData** em uma cadeia de caracteres.
