...
Para baixar uma amostra dos usos mais avançados das APIs [**Windows.Devices.Enumeration**](https://msdn.microsoft.com/library/windows/apps/BR225459), clique [aqui](https://go.microsoft.com/fwlink/?LinkID=620536).
