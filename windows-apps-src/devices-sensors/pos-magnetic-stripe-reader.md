...
ms.locfileid: "8338788"
---
# <a name="magnetic-stripe-reader"></a>Leitor de tarjas magnéticas

Um leitor de tarja magnética poderá verificar certos tipos de cartões têm uma tarja magnética neles, como cartões de crédito, licenças do driver, e armazenar os cartões de fidelidade. Você provavelmente encontraram uma ao comprar algo em um repositório.
...
Os tópicos a seguir fornecem mais informações sobre como usar um leitor de tarja magnética em seu aplicativo.
