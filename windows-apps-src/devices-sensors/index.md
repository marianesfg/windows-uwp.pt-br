...
| [Obter informações de bateria](get-battery-info.md) | Saiba como obter informações de bateria detalhadas usando APIs no namespace [<strong>Windows.Devices.Power</strong>](https://msdn.microsoft.com/library/windows/apps/Dn895017). |
